...
/// <summary>
/// One localized label/value pair displayed in the track information dialog. It lives
/// outside the window so XAML can name it in an <c>x:DataType</c> directive, which
/// compiled bindings require (a nested type cannot be referenced from XAML).
/// </summary>
/// <param name="Label">Localized field label.</param>
/// <param name="Value">Displayed field value.</param>
