...
public static class LocalizationManager
{
        ...
        "Ein unerwarteter Fehler ist aufgetreten. Der Fehlerbericht konnte nicht gespeichert werden. Orynivo wird beendet.")
    {
        ...
        AirPlay = "AirPlay",
        AirPlayOutputDevice = "AirPlay-Ausgabegerät",
        NoAirPlayDevices = "Keine AirPlay-Geräte im lokalen Netzwerk gefunden.",
        AirPlaySenderMissing = "Für AirPlay wird das kompatible Hilfsprogramm „raop_play“ neben Orynivo oder im PATH benötigt.",
        ...
        "An unexpected error occurred. The crash report could not be saved. Orynivo will now close.")
    {
        ...
        AirPlay = "AirPlay", AirPlayOutputDevice = "AirPlay output device",
        NoAirPlayDevices = "No AirPlay devices were found on the local network.",
        AirPlaySenderMissing = "AirPlay requires the compatible “raop_play” helper beside Orynivo or on PATH.",
        ...
        "Une erreur inattendue s’est produite. Le rapport n’a pas pu être enregistré. Orynivo va maintenant se fermer.")
    {
        ...
        AirPlay = "AirPlay", AirPlayOutputDevice = "Périphérique de sortie AirPlay",
        NoAirPlayDevices = "Aucun appareil AirPlay n’a été trouvé sur le réseau local.",
        AirPlaySenderMissing = "AirPlay nécessite l’utilitaire compatible « raop_play » à côté d’Orynivo ou dans le PATH.",
        ...
        "Se produjo un error inesperado. No se pudo guardar el informe. Orynivo se cerrará ahora.")
    {
        ...
        AirPlay = "AirPlay", AirPlayOutputDevice = "Dispositivo de salida AirPlay",
        NoAirPlayDevices = "No se encontraron dispositivos AirPlay en la red local.",
        AirPlaySenderMissing = "AirPlay requiere la utilidad compatible «raop_play» junto a Orynivo o en PATH.",
