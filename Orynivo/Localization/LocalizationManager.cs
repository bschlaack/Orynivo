...
public static class LocalizationManager
{
    ...
    public static void Apply(Language language)
    {
        var culture = language switch
        {
            ...
            Language.Hindi => CultureInfo.GetCultureInfo("hi-IN"),
        ...
        resources["L_DuplicateResolutionTitle"] = Current.DuplicateResolutionTitle;
        resources["L_DuplicateResolutionHint"] = Current.DuplicateResolutionHint;
        resources["L_DuplicateResolutionGroupHeader"] = Current.DuplicateResolutionGroupHeader;
        resources["L_DuplicateResolutionExact"] = Current.DuplicateResolutionExact;
        resources["L_DuplicateResolutionLikely"] = Current.DuplicateResolutionLikely;
        resources["L_DuplicateResolutionSelected"] = Current.DuplicateResolutionSelected;
        resources["L_DuplicateResolutionRemove"] = Current.DuplicateResolutionRemove;
        resources["L_DuplicateResolutionDeleteFiles"] = Current.DuplicateResolutionDeleteFiles;
        resources["L_DuplicateResolutionConfirmRemove"] = Current.DuplicateResolutionConfirmRemove;
        resources["L_DuplicateResolutionConfirmDeleteFiles"] = Current.DuplicateResolutionConfirmDeleteFiles;
        resources["L_DuplicateResolutionNoneFound"] = Current.DuplicateResolutionNoneFound;
        resources["L_DuplicateResolutionRemoved"] = Current.DuplicateResolutionRemoved;
        ...
        resources["L_BulkGenrePartiallyFailed"] = Current.BulkGenrePartiallyFailed;
        ...
        resources["L_ScheduledBackupInterval"] = Current.ScheduledBackupInterval;
        resources["L_ScheduledBackupRetention"] = Current.ScheduledBackupRetention;
        resources["L_ScheduledBackupFolder"] = Current.ScheduledBackupFolder;
        resources["L_ChooseFolder"] = Current.ChooseFolder;
        resources["L_RunBackupNow"] = Current.RunBackupNow;
        resources["L_ScheduledBackupLastRun"] = Current.ScheduledBackupLastRun;
        resources["L_ScheduledBackupNever"] = Current.ScheduledBackupNever;
        resources["L_ScheduledBackupRunning"] = Current.ScheduledBackupRunning;
        resources["L_ScheduledBackupFinished"] = Current.ScheduledBackupFinished;
        resources["L_ScheduledBackupFailed"] = Current.ScheduledBackupFailed;
        resources["L_ScheduledBackupDone"] = Current.ScheduledBackupDone;
        resources["L_VisualizerPresetFolder"] = Current.VisualizerPresetFolder;
        resources["L_VisualizerPresetFolderHint"] = Current.VisualizerPresetFolderHint;
        resources["L_VisualizerPresetRejected"] = Current.VisualizerPresetRejected;
        resources["L_Visualizer"] = Current.Visualizer;
        resources["L_VisualizerHint"] = Current.VisualizerHint;
        resources["L_VisualizerPresetLabel"] = Current.VisualizerPresetLabel;
        resources["L_VisualizerOverlayAlways"] = Current.VisualizerOverlayAlways;
        resources["L_VisualizerOverlayAlwaysHint"] = Current.VisualizerOverlayAlwaysHint;
        resources["L_VisualizerResolution"] = Current.VisualizerResolution;
        resources["L_VisualizerResolutionHint"] = Current.VisualizerResolutionHint;
        resources["L_VisualizerFrameRate"] = Current.VisualizerFrameRate;
        resources["L_VisualizerFrameRateHint"] = Current.VisualizerFrameRateHint;
        resources["L_VisualizerAutoAdvance"] = Current.VisualizerAutoAdvance;
        resources["L_VisualizerAutoAdvanceHint"] = Current.VisualizerAutoAdvanceHint;
        resources["L_VisualizerAutoAdvanceSeconds"] = Current.VisualizerAutoAdvanceSeconds;
        resources["L_VisualizerPresetBlendSeconds"] = Current.VisualizerPresetBlendSeconds;
        resources["L_VisualizerPresetBlendSecondsHint"] = Current.VisualizerPresetBlendSecondsHint;
        resources["L_VisualizerSelectPresets"] = Current.VisualizerSelectPresets;
        resources["L_VisualizerSelectPresetsHint"] = Current.VisualizerSelectPresetsHint;
        resources["L_VisualizerPresetDownloadHint"] = Current.VisualizerPresetDownloadHint;
        resources["L_VisualizerDownloadPresets"] = Current.VisualizerDownloadPresets;
        resources["L_VisualizerPresetSelectionTitle"] = Current.VisualizerPresetSelectionTitle;
        resources["L_VisualizerPresetSelectionHint"] = Current.VisualizerPresetSelectionHint;
        resources["L_VisualizerPresetSelectionAll"] = Current.VisualizerPresetSelectionAll;
        resources["L_VisualizerPresetSelectionNone"] = Current.VisualizerPresetSelectionNone;
        resources["L_VisualizerPresetSelectionLoading"] = Current.VisualizerPresetSelectionLoading;
        resources["L_VisualizerPresetSelectionEmpty"] = Current.VisualizerPresetSelectionEmpty;
        resources["L_VisualizerPresetSelectionActiveCount"] = Current.VisualizerPresetSelectionActiveCount;
        resources["L_MaxOutputSampleRate"] = Current.MaxOutputSampleRate;
        resources["L_MaxOutputSampleRateHint"] = Current.MaxOutputSampleRateHint;
        resources["L_MaxOutputSampleRateAutomatic"] = Current.MaxOutputSampleRateAutomatic;
        resources["L_ResumeOnThisDevice"] = Current.ResumeOnThisDevice;
        resources["L_ResumeOnThisDeviceTooltip"] = Current.ResumeOnThisDeviceTooltip;
        resources["L_ResumeOnThisDeviceHint"] = Current.ResumeOnThisDeviceHint;
        resources["L_TransportPrevious"] = Current.TransportPrevious;
        resources["L_TransportPlayPause"] = Current.TransportPlayPause;
        resources["L_TransportNext"] = Current.TransportNext;
        resources["L_TransportVolume"] = Current.TransportVolume;
        resources["L_ReduceMotion"] = Current.ReduceMotion;
        resources["L_ReduceMotionHint"] = Current.ReduceMotionHint;
        resources["L_ReduceMotionEnabled"] = Current.ReduceMotionEnabled;
        resources["L_BackupTarget"] = Current.BackupTarget;
        resources["L_BackupTargetHint"] = Current.BackupTargetHint;
        resources["L_BackupTargetEnabled"] = Current.BackupTargetEnabled;
        resources["L_BackupTargetUrl"] = Current.BackupTargetUrl;
        resources["L_BackupTargetDirectory"] = Current.BackupTargetDirectory;
        resources["L_BackupTargetUserName"] = Current.BackupTargetUserName;
        resources["L_BackupTargetPassword"] = Current.BackupTargetPassword;
        resources["L_BackupUploadDone"] = Current.BackupUploadDone;
        resources["L_BackupUploadFailed"] = Current.BackupUploadFailed;
        ...
        resources["L_YearInReviewActiveDays"] = Current.YearInReviewActiveDays;
        resources["L_YearInReviewMonthly"] = Current.YearInReviewMonthly;
        resources["L_YearInReviewTopGenres"] = Current.YearInReviewTopGenres;
        resources["L_YearInReviewTopAlbums"] = Current.YearInReviewTopAlbums;
        resources["L_YearInReviewTopArtists"] = Current.YearInReviewTopArtists;
        resources["L_YearInReviewEmpty"] = Current.YearInReviewEmpty;
        resources["L_SaveAsImage"] = Current.SaveAsImage;
        resources["L_YearInReviewImageSaved"] = Current.YearInReviewImageSaved;
        resources["L_YearInReviewImageFailed"] = Current.YearInReviewImageFailed;
        ...
        "Ein unerwarteter Fehler ist aufgetreten. Der Fehlerbericht konnte nicht gespeichert werden. Orynivo wird beendet.")
    {
        ...
        BulkGenrePartiallyFailed = "Genre für {0} Titel aktualisiert, {1} fehlgeschlagen.",
        ...
        ScheduledBackupInterval = "Abstand in Tagen",
        ScheduledBackupRetention = "Anzahl aufbewahrter Backups",
        ScheduledBackupFolder = "Backup-Ordner",
        ChooseFolder = "Ordner wählen…",
        RunBackupNow = "Jetzt sichern",
        ScheduledBackupLastRun = "Letztes Backup: {0}",
        ScheduledBackupNever = "nie",
        ScheduledBackupRunning = "Backup wird erstellt…",
        ScheduledBackupFinished = "Backup abgeschlossen.",
        ScheduledBackupFailed = "Backup fehlgeschlagen.",
        ScheduledBackupDone = "Backup erstellt: {0}",
        VisualizerPresetFolder = "Preset-Ordner",
        VisualizerPresetFolderHint = "Eigene Presets als .oryvis- oder .milk-Dateien. Unterstützt wird die Ausdrucks-Teilmenge; unbekannte Schlüssel werden ignoriert. Nicht lesbare Dateien werden übersprungen.",
        VisualizerPresetRejected = "Presets übersprungen",
        Visualizer = "Visualisierung",
        VisualizerHint = "Leertaste oder Klick: nächstes Preset · Pfeiltasten: vor/zurück · R: zurücksetzen · Esc: schließen",
        VisualizerPresetLabel = "Preset: {0}",
        VisualizerOverlayAlways = "Text und Steuerelemente dauerhaft anzeigen",
        VisualizerOverlayAlwaysHint = "Wenn deaktiviert, erscheinen Titel, Hinweis und Wiedergabetasten nur bei einer Mausbewegung über der Visualisierung und blenden sich danach wieder aus.",
        VisualizerResolution = "Auflösung",
        VisualizerResolutionHint = "Kleinere Auflösungen entlasten die CPU; das Bild wird auf die Fenstergröße skaliert.",
        VisualizerFrameRate = "Bildrate",
        VisualizerFrameRateHint = "Höhere Bildraten wirken flüssiger, kosten aber mehr CPU-Leistung.",
        VisualizerAutoAdvance = "Presets automatisch wechseln",
        VisualizerAutoAdvanceHint = "Zeigt nach der angegebenen Zeit automatisch das nächste Preset an.",
        VisualizerAutoAdvanceSeconds = "Anzeigedauer pro Preset (Sekunden)",
        VisualizerPresetBlendSeconds = "Überblenddauer beim Preset-Wechsel (Sekunden)",
        VisualizerPresetBlendSecondsHint = "0 schaltet hart um; ein höherer Wert blendet das vorige Preset weich in das neue über.",
        VisualizerSelectPresets = "Presets auswählen…",
        VisualizerSelectPresetsHint = "Wähle aus, welche Presets die Visualisierung abspielt; deaktivierte werden übersprungen.",
        VisualizerPresetDownloadHint = "Orynivo liefert keine fremden Presets mit. MilkDrop-2-Preset-Sammlungen lassen sich herunterladen und in den Preset-Ordner legen.",
        VisualizerDownloadPresets = "Presets herunterladen…",
        VisualizerPresetSelectionTitle = "Visualizer-Presets",
        VisualizerPresetSelectionHint = "Deaktivierte Presets werden beim Wechseln und beim automatischen Wechsel übersprungen.",
        VisualizerPresetSelectionAll = "Alle",
        VisualizerPresetSelectionNone = "Keine",
        VisualizerPresetSelectionLoading = "Presets werden geladen…",
        VisualizerPresetSelectionEmpty = "In diesem Ordner wurden keine Presets gefunden.",
        VisualizerPresetSelectionActiveCount = "{0} von {1} aktiv",
        MaxOutputSampleRate = "Maximale Ausgaberate",
        MaxOutputSampleRateHint = "Begrenzt die PCM-Ausgaberate. Automatisch nutzt die höchste Rate, die das Gerät anbietet – sinnvoll, wenn ein Treiber eine Rate meldet, die er nicht sauber wiedergibt.",
        MaxOutputSampleRateAutomatic = "Automatisch",
        ResumeOnThisDevice = "Fortsetzen",
        ResumeOnThisDeviceTooltip = "Auf diesem Gerät bei {0} fortsetzen",
        ResumeOnThisDeviceHint = "Wiedergabe bei {0} fortgesetzt",
        TransportPrevious = "Vorheriger Titel",
        TransportPlayPause = "Wiedergabe oder Pause",
        TransportNext = "Nächster Titel",
        TransportVolume = "Lautstärke",
        ReduceMotion = "Animationen",
        ReduceMotionHint = "Reduziert Bewegung in der Oberfläche: Genre Cloud, Dashboard-Bühnenübergänge und Karaoke werden ohne Überblendungen gewechselt.",
        ReduceMotionEnabled = "Bewegung reduzieren",
        BackupTarget = "Cloud-Backup-Ziel",
        BackupTargetHint = "Erstellt fertige Backups zusätzlich auf einem WebDAV-Speicher. Das Passwort wird verschlüsselt gespeichert und nie in die Einstellungsdatei geschrieben.",
        BackupTargetEnabled = "Backups auf das WebDAV-Ziel hochladen",
        BackupTargetUrl = "WebDAV-Adresse",
        BackupTargetDirectory = "Unterordner (optional)",
        BackupTargetUserName = "Benutzername (optional)",
        BackupTargetPassword = "Passwort (optional)",
        BackupUploadDone = "Backup hochgeladen: {0}",
        BackupUploadFailed = "Backup-Upload fehlgeschlagen.",
        Karaoke = "Karaoke",
        ...
        YearInReviewActiveDays = "Aktive Tage",
        YearInReviewMonthly = "Hörzeit pro Monat",
        YearInReviewTopGenres = "Top-Genres",
        YearInReviewTopAlbums = "Top-Alben",
        YearInReviewTopArtists = "Top-Interpreten",
        YearInReviewEmpty = "Für dieses Jahr wurden keine Wiedergaben aufgezeichnet.",
        SaveAsImage = "Als Bild speichern…",
        YearInReviewImageSaved = "Bild gespeichert: {0}",
        YearInReviewImageFailed = "Das Bild konnte nicht gespeichert werden.",
        ...
        DuplicateResolutionExact = "Byte-identisch",
        DuplicateResolutionLikely = "Wahrscheinlich doppelt",
        DuplicateResolutionSelected = "{0} zur Entfernung ausgewählt",
        DuplicateResolutionRemove = "Aus Bibliothek entfernen",
        DuplicateResolutionDeleteFiles = "Die Dateien auch von der Festplatte löschen",
        DuplicateResolutionConfirmRemove = "{0} Dateien aus der Bibliothek entfernen?",
        DuplicateResolutionConfirmDeleteFiles = "{0} Dateien aus der Bibliothek entfernen und von der Festplatte löschen?",
        DuplicateResolutionNoneFound = "Es wurden keine doppelten Dateien gefunden.",
        DuplicateResolutionRemoved = "{0} Dateien aus der Bibliothek entfernt.",
        ...
        TopAlbums = "Meistgehörte Alben (in Minuten)",
        ...
        , CoverSearchFailed = "Das Cover konnte nicht geladen werden. Bitte erneut versuchen."
        , CoverOriginalLoading = "Originalcover wird heruntergeladen …"
        ...
        "An unexpected error occurred. The crash report could not be saved. Orynivo will now close.")
    {
        ...
        BulkGenrePartiallyFailed = "Updated the genre of {0} track(s); {1} failed.",
        ...
        ScheduledBackupInterval = "Interval in days",
        ScheduledBackupRetention = "Backups to keep",
        ScheduledBackupFolder = "Backup folder",
        ChooseFolder = "Choose folder…",
        RunBackupNow = "Back up now",
        ScheduledBackupLastRun = "Last backup: {0}",
        ScheduledBackupNever = "never",
        ScheduledBackupRunning = "Creating backup…",
        ScheduledBackupFinished = "Backup finished.",
        ScheduledBackupFailed = "Backup failed.",
        ScheduledBackupDone = "Backup created: {0}",
        VisualizerPresetFolder = "Preset folder",
        VisualizerPresetFolderHint = "Your own presets as .oryvis or .milk files. The supported expression subset applies and unknown keys are ignored; unreadable files are skipped.",
        VisualizerPresetRejected = "presets skipped",
        Visualizer = "Visualizer",
        VisualizerHint = "Space or click: next preset · arrow keys: previous/next · R: reset · Esc: close",
        VisualizerPresetLabel = "Preset: {0}",
        VisualizerOverlayAlways = "Always show text and controls",
        VisualizerOverlayAlwaysHint = "When disabled, the title, hint, and playback buttons appear only when the mouse moves over the visualizer and hide again afterwards.",
        VisualizerResolution = "Resolution",
        VisualizerResolutionHint = "Lower resolutions are easier on the CPU; the picture is scaled up to the window size.",
        VisualizerFrameRate = "Frame rate",
        VisualizerFrameRateHint = "Higher frame rates look smoother but use more CPU.",
        VisualizerAutoAdvance = "Automatically change presets",
        VisualizerAutoAdvanceHint = "Shows the next preset automatically after the given time.",
        VisualizerAutoAdvanceSeconds = "Display time per preset (seconds)",
        VisualizerPresetBlendSeconds = "Preset switch cross-fade duration (seconds)",
        VisualizerPresetBlendSecondsHint = "0 switches hard; a higher value cross-fades the previous preset into the new one.",
        VisualizerSelectPresets = "Select presets…",
        VisualizerSelectPresetsHint = "Choose which presets the visualizer plays; deactivated ones are skipped.",
        VisualizerPresetDownloadHint = "Orynivo ships no third-party presets. MilkDrop 2 preset collections can be downloaded and placed in the preset folder.",
        VisualizerDownloadPresets = "Download presets…",
        VisualizerPresetSelectionTitle = "Visualizer presets",
        VisualizerPresetSelectionHint = "Deactivated presets are skipped while switching and during automatic advance.",
        VisualizerPresetSelectionAll = "All",
        VisualizerPresetSelectionNone = "None",
        VisualizerPresetSelectionLoading = "Loading presets…",
        VisualizerPresetSelectionEmpty = "No presets were found in this folder.",
        VisualizerPresetSelectionActiveCount = "{0} of {1} active",
        MaxOutputSampleRate = "Maximum output sample rate",
        MaxOutputSampleRateHint = "Caps the PCM output sample rate. Automatic uses the highest rate the device offers, which is worth limiting when a driver advertises a rate it cannot reproduce cleanly.",
        MaxOutputSampleRateAutomatic = "Automatic",
        ResumeOnThisDevice = "Resume",
        ResumeOnThisDeviceTooltip = "Resume on this device at {0}",
        ResumeOnThisDeviceHint = "Resumed at {0}",
        TransportPrevious = "Previous track",
        TransportPlayPause = "Play or pause",
        TransportNext = "Next track",
        TransportVolume = "Volume",
        ReduceMotion = "Animations",
        ReduceMotionHint = "Reduces motion in the interface: the Genre Cloud, Dashboard cover stage, and karaoke switch without transitions.",
        ReduceMotionEnabled = "Reduce motion",
        BackupTarget = "Cloud backup target",
        BackupTargetHint = "Also stores completed backups on WebDAV storage. The password is stored encrypted and never written to the settings file.",
        BackupTargetEnabled = "Upload backups to the WebDAV target",
        BackupTargetUrl = "WebDAV URL",
        BackupTargetDirectory = "Sub-folder (optional)",
        BackupTargetUserName = "User name (optional)",
        BackupTargetPassword = "Password (optional)",
        BackupUploadDone = "Backup uploaded: {0}",
        BackupUploadFailed = "Backup upload failed.",
        Karaoke = "Karaoke",
        ...
        YearInReviewActiveDays = "Active days",
        YearInReviewMonthly = "Listening by month",
        YearInReviewTopGenres = "Top genres",
        YearInReviewTopAlbums = "Top albums",
        YearInReviewTopArtists = "Top artists",
        YearInReviewEmpty = "No listening history was recorded for this year.",
        SaveAsImage = "Save as image…",
        YearInReviewImageSaved = "Image saved: {0}",
        YearInReviewImageFailed = "Could not save the image.",
        ...
        DuplicateResolutionExact = "Byte-identical",
        DuplicateResolutionLikely = "Likely duplicates",
        DuplicateResolutionSelected = "{0} selected for removal",
        DuplicateResolutionRemove = "Remove from library",
        DuplicateResolutionDeleteFiles = "Also delete the files from disk",
        DuplicateResolutionConfirmRemove = "Remove {0} files from the library?",
        DuplicateResolutionConfirmDeleteFiles = "Remove {0} files from the library and delete them from disk?",
        DuplicateResolutionNoneFound = "No duplicate files were found.",
        DuplicateResolutionRemoved = "Removed {0} files from the library.",
        ...
        TopAlbums = "Most listened albums (in minutes)",
        ...
        , CoverSearchFailed = "The cover could not be loaded. Please try again."
        , CoverOriginalLoading = "Downloading original cover …"
        ...
        "Une erreur inattendue s’est produite. Le rapport n’a pas pu être enregistré. Orynivo va maintenant se fermer.")
    {
        ...
        BulkGenrePartiallyFailed = "Genre mis à jour pour {0} piste(s) ; {1} en échec.",
        ...
        ScheduledBackupInterval = "Intervalle en jours",
        ScheduledBackupRetention = "Sauvegardes à conserver",
        ScheduledBackupFolder = "Dossier de sauvegarde",
        ChooseFolder = "Choisir un dossier…",
        RunBackupNow = "Sauvegarder maintenant",
        ScheduledBackupLastRun = "Dernière sauvegarde : {0}",
        ScheduledBackupNever = "jamais",
        ScheduledBackupRunning = "Création de la sauvegarde…",
        ScheduledBackupFinished = "Sauvegarde terminée.",
        ScheduledBackupFailed = "Échec de la sauvegarde.",
        ScheduledBackupDone = "Sauvegarde créée : {0}",
        VisualizerPresetFolder = "Dossier des presets",
        VisualizerPresetFolderHint = "Vos propres presets au format .oryvis ou .milk. Le sous-ensemble d'expressions pris en charge s'applique et les clés inconnues sont ignorées ; les fichiers illisibles sont ignorés.",
        VisualizerPresetRejected = "presets ignorés",
        Visualizer = "Visualisation",
        VisualizerHint = "Espace ou clic : preset suivant · flèches : précédent/suivant · R : réinitialiser · Échap : fermer",
        VisualizerPresetLabel = "Preset : {0}",
        VisualizerOverlayAlways = "Toujours afficher le texte et les commandes",
        VisualizerOverlayAlwaysHint = "Si désactivé, le titre, l'astuce et les boutons de lecture n'apparaissent que lorsque la souris bouge sur la visualisation, puis disparaissent.",
        VisualizerResolution = "Résolution",
        VisualizerResolutionHint = "Les résolutions basses sollicitent moins le processeur ; l'image est agrandie à la taille de la fenêtre.",
        VisualizerFrameRate = "Fréquence d'images",
        VisualizerFrameRateHint = "Des fréquences plus élevées sont plus fluides mais consomment plus de processeur.",
        VisualizerAutoAdvance = "Changer automatiquement de preset",
        VisualizerAutoAdvanceHint = "Affiche automatiquement le preset suivant après le délai indiqué.",
        VisualizerAutoAdvanceSeconds = "Durée d'affichage par preset (secondes)",
        VisualizerPresetBlendSeconds = "Durée de fondu enchaîné entre presets (secondes)",
        VisualizerPresetBlendSecondsHint = "0 bascule sans fondu ; une valeur supérieure fond l'ancien preset dans le nouveau.",
        VisualizerSelectPresets = "Sélectionner les presets…",
        VisualizerSelectPresetsHint = "Choisis les presets que lit le visualiseur ; les presets désactivés sont ignorés.",
        VisualizerPresetDownloadHint = "Orynivo ne fournit aucun preset tiers. Les collections de presets MilkDrop 2 peuvent être téléchargées et placées dans le dossier des presets.",
        VisualizerDownloadPresets = "Télécharger des presets…",
        VisualizerPresetSelectionTitle = "Presets du visualiseur",
        VisualizerPresetSelectionHint = "Les presets désactivés sont ignorés lors du changement et de l'avance automatique.",
        VisualizerPresetSelectionAll = "Tous",
        VisualizerPresetSelectionNone = "Aucun",
        VisualizerPresetSelectionLoading = "Chargement des presets…",
        VisualizerPresetSelectionEmpty = "Aucun preset n'a été trouvé dans ce dossier.",
        VisualizerPresetSelectionActiveCount = "{0} sur {1} actifs",
        MaxOutputSampleRate = "Fréquence d'échantillonnage de sortie maximale",
        MaxOutputSampleRateHint = "Limite la fréquence d'échantillonnage PCM de sortie. Automatique utilise la fréquence la plus élevée proposée par l'appareil, ce qu'il vaut mieux limiter lorsqu'un pilote annonce une fréquence qu'il ne restitue pas proprement.",
        MaxOutputSampleRateAutomatic = "Automatique",
        ResumeOnThisDevice = "Reprendre",
        ResumeOnThisDeviceTooltip = "Reprendre sur cet appareil à {0}",
        ResumeOnThisDeviceHint = "Reprise à {0}",
        TransportPrevious = "Piste précédente",
        TransportPlayPause = "Lire ou mettre en pause",
        TransportNext = "Piste suivante",
        TransportVolume = "Volume",
        ReduceMotion = "Animations",
        ReduceMotionHint = "Réduit les mouvements de l'interface : le Genre Cloud, la scène du tableau de bord et le karaoké changent sans transitions.",
        ReduceMotionEnabled = "Réduire les animations",
        BackupTarget = "Cible de sauvegarde cloud",
        BackupTargetHint = "Stocke aussi les sauvegardes terminées sur un stockage WebDAV. Le mot de passe est chiffré et n'est jamais écrit dans le fichier de paramètres.",
        BackupTargetEnabled = "Téléverser les sauvegardes vers la cible WebDAV",
        BackupTargetUrl = "URL WebDAV",
        BackupTargetDirectory = "Sous-dossier (facultatif)",
        BackupTargetUserName = "Nom d'utilisateur (facultatif)",
        BackupTargetPassword = "Mot de passe (facultatif)",
        BackupUploadDone = "Sauvegarde téléversée : {0}",
        BackupUploadFailed = "Echec du téléversement de la sauvegarde.",
        Karaoke = "Karaoké",
        ...
        YearInReviewActiveDays = "Jours actifs",
        YearInReviewMonthly = "Écoute par mois",
        YearInReviewTopGenres = "Genres principaux",
        YearInReviewTopAlbums = "Albums principaux",
        YearInReviewTopArtists = "Artistes principaux",
        YearInReviewEmpty = "Aucun historique d'écoute n'a été enregistré pour cette année.",
        SaveAsImage = "Enregistrer comme image…",
        YearInReviewImageSaved = "Image enregistrée : {0}",
        YearInReviewImageFailed = "Impossible d'enregistrer l'image.",
        ...
        DuplicateResolutionExact = "Identiques octet par octet",
        DuplicateResolutionLikely = "Doublons probables",
        DuplicateResolutionSelected = "{0} sélectionné(s) pour suppression",
        DuplicateResolutionRemove = "Retirer de la bibliothèque",
        DuplicateResolutionDeleteFiles = "Supprimer aussi les fichiers du disque",
        DuplicateResolutionConfirmRemove = "Retirer {0} fichiers de la bibliothèque ?",
        DuplicateResolutionConfirmDeleteFiles = "Retirer {0} fichiers de la bibliothèque et les supprimer du disque ?",
        DuplicateResolutionNoneFound = "Aucun fichier en double n'a été trouvé.",
        DuplicateResolutionRemoved = "{0} fichiers retirés de la bibliothèque.",
        ...
        TopAlbums = "Albums les plus écoutés (en minutes)",
        ...
        , CoverSearchFailed = "Impossible de charger la pochette. Veuillez réessayer."
        , CoverOriginalLoading = "Téléchargement de la pochette originale …"
        ...
        "Se produjo un error inesperado. No se pudo guardar el informe. Orynivo se cerrará ahora.")
    {
        ...
        BulkGenrePartiallyFailed = "Género actualizado para {0} pista(s); {1} fallidas.",
        ...
        ScheduledBackupInterval = "Intervalo en días",
        ScheduledBackupRetention = "Copias a conservar",
        ScheduledBackupFolder = "Carpeta de copias",
        ChooseFolder = "Elegir carpeta…",
        RunBackupNow = "Copiar ahora",
        ScheduledBackupLastRun = "Última copia: {0}",
        ScheduledBackupNever = "nunca",
        ScheduledBackupRunning = "Creando copia…",
        ScheduledBackupFinished = "Copia completada.",
        ScheduledBackupFailed = "Error en la copia.",
        ScheduledBackupDone = "Copia creada: {0}",
        VisualizerPresetFolder = "Carpeta de preajustes",
        VisualizerPresetFolderHint = "Tus propios preajustes como archivos .oryvis o .milk. Se aplica el subconjunto de expresiones admitido y las claves desconocidas se ignoran; los archivos ilegibles se omiten.",
        VisualizerPresetRejected = "preajustes omitidos",
        Visualizer = "Visualización",
        VisualizerHint = "Espacio o clic: siguiente preajuste · flechas: anterior/siguiente · R: restablecer · Esc: cerrar",
        VisualizerPresetLabel = "Preajuste: {0}",
        VisualizerOverlayAlways = "Mostrar siempre el texto y los controles",
        VisualizerOverlayAlwaysHint = "Si se desactiva, el título, la ayuda y los botones de reproducción solo aparecen al mover el ratón sobre la visualización y se ocultan después.",
        VisualizerResolution = "Resolución",
        VisualizerResolutionHint = "Las resoluciones bajas consumen menos CPU; la imagen se escala al tamaño de la ventana.",
        VisualizerFrameRate = "Frecuencia de imágenes",
        VisualizerFrameRateHint = "Las frecuencias altas se ven más fluidas pero consumen más CPU.",
        VisualizerAutoAdvance = "Cambiar de preset automáticamente",
        VisualizerAutoAdvanceHint = "Muestra automáticamente el siguiente preset tras el tiempo indicado.",
        VisualizerAutoAdvanceSeconds = "Duración de visualización por preset (segundos)",
        VisualizerPresetBlendSeconds = "Duración de fundido entre presets (segundos)",
        VisualizerPresetBlendSecondsHint = "0 cambia sin fundido; un valor mayor funde el preset anterior en el nuevo.",
        VisualizerSelectPresets = "Seleccionar presets…",
        VisualizerSelectPresetsHint = "Elige qué presets reproduce el visualizador; los desactivados se omiten.",
        VisualizerPresetDownloadHint = "Orynivo no incluye presets de terceros. Las colecciones de presets de MilkDrop 2 se pueden descargar y colocar en la carpeta de presets.",
        VisualizerDownloadPresets = "Descargar presets…",
        VisualizerPresetSelectionTitle = "Presets del visualizador",
        VisualizerPresetSelectionHint = "Los presets desactivados se omiten al cambiar y en el avance automático.",
        VisualizerPresetSelectionAll = "Todos",
        VisualizerPresetSelectionNone = "Ninguno",
        VisualizerPresetSelectionLoading = "Cargando presets…",
        VisualizerPresetSelectionEmpty = "No se encontraron presets en esta carpeta.",
        VisualizerPresetSelectionActiveCount = "{0} de {1} activos",
        MaxOutputSampleRate = "Frecuencia de muestreo de salida máxima",
        MaxOutputSampleRateHint = "Limita la frecuencia de muestreo PCM de salida. Automática usa la frecuencia más alta que ofrece el dispositivo, algo que conviene limitar cuando un controlador anuncia una frecuencia que no reproduce con limpieza.",
        MaxOutputSampleRateAutomatic = "Automática",
        ResumeOnThisDevice = "Reanudar",
        ResumeOnThisDeviceTooltip = "Reanudar en este dispositivo en {0}",
        ResumeOnThisDeviceHint = "Reanudado en {0}",
        TransportPrevious = "Pista anterior",
        TransportPlayPause = "Reproducir o pausar",
        TransportNext = "Pista siguiente",
        TransportVolume = "Volumen",
        ReduceMotion = "Animaciones",
        ReduceMotionHint = "Reduce el movimiento de la interfaz: la nube de géneros, el escenario del panel y el karaoke cambian sin transiciones.",
        ReduceMotionEnabled = "Reducir el movimiento",
        BackupTarget = "Destino de copia en la nube",
        BackupTargetHint = "También guarda las copias completadas en un almacenamiento WebDAV. La contraseña se guarda cifrada y nunca se escribe en el archivo de ajustes.",
        BackupTargetEnabled = "Subir copias al destino WebDAV",
        BackupTargetUrl = "Dirección WebDAV",
        BackupTargetDirectory = "Subcarpeta (opcional)",
        BackupTargetUserName = "Nombre de usuario (opcional)",
        BackupTargetPassword = "Contraseña (opcional)",
        BackupUploadDone = "Copia subida: {0}",
        BackupUploadFailed = "Error al subir la copia.",
        Karaoke = "Karaoke",
        ...
        YearInReviewActiveDays = "Días activos",
        YearInReviewMonthly = "Escucha por mes",
        YearInReviewTopGenres = "Géneros principales",
        YearInReviewTopAlbums = "Álbumes principales",
        YearInReviewTopArtists = "Artistas principales",
        YearInReviewEmpty = "No se registró historial de escucha para este año.",
        SaveAsImage = "Guardar como imagen…",
        YearInReviewImageSaved = "Imagen guardada: {0}",
        YearInReviewImageFailed = "No se pudo guardar la imagen.",
        ...
        DuplicateResolutionExact = "Idénticos byte a byte",
        DuplicateResolutionLikely = "Probables duplicados",
        DuplicateResolutionSelected = "{0} seleccionado(s) para eliminar",
        DuplicateResolutionRemove = "Quitar de la biblioteca",
        DuplicateResolutionDeleteFiles = "Eliminar también los archivos del disco",
        DuplicateResolutionConfirmRemove = "¿Quitar {0} archivos de la biblioteca?",
        DuplicateResolutionConfirmDeleteFiles = "¿Quitar {0} archivos de la biblioteca y eliminarlos del disco?",
        DuplicateResolutionNoneFound = "No se encontraron archivos duplicados.",
        DuplicateResolutionRemoved = "Se quitaron {0} archivos de la biblioteca.",
        ...
        TopAlbums = "Álbumes más escuchados (en minutos)",
        ...
        , CoverSearchFailed = "No se pudo cargar la portada. Inténtalo de nuevo."
        , CoverOriginalLoading = "Descargando la portada original …"
...
private static readonly LocalizedStrings Russian = new(
        ...
        "Произошла непредвиденная ошибка. Не удалось сохранить отчёт о сбое. Orynivo будет закрыт.")
    {
        ...
        TopAlbums = "Самые прослушиваемые альбомы (в минутах)",
        ...
        CoverSearchFailed = "Не удалось загрузить обложку. Повторите попытку.",
        CoverOriginalLoading = "Загрузка оригинала обложки …",
        ...
        BulkGenrePartiallyFailed = "Жанр обновлён для {0} треков; ошибок: {1}.",
        ...
        ScheduledBackupInterval = "Интервал в днях",
        ScheduledBackupRetention = "Хранить копий",
        ScheduledBackupFolder = "Папка резервных копий",
        ChooseFolder = "Выбрать папку…",
        RunBackupNow = "Создать копию сейчас",
        ScheduledBackupLastRun = "Последняя копия: {0}",
        ScheduledBackupNever = "никогда",
        ScheduledBackupRunning = "Создание копии…",
        ScheduledBackupFinished = "Копия создана.",
        ScheduledBackupFailed = "Не удалось создать копию.",
        ScheduledBackupDone = "Копия создана: {0}",
        VisualizerPresetFolder = "Папка пресетов",
        VisualizerPresetFolderHint = "Собственные пресеты в формате .oryvis или .milk. Поддерживается описанное подмножество выражений, неизвестные ключи игнорируются; нечитаемые файлы пропускаются.",
        VisualizerPresetRejected = "пресетов пропущено",
        Visualizer = "Визуализация",
        VisualizerHint = "Пробел или щелчок: следующий пресет · стрелки: назад/вперёд · R: сброс · Esc: закрыть",
        VisualizerPresetLabel = "Пресет: {0}",
        VisualizerOverlayAlways = "Всегда показывать текст и элементы управления",
        VisualizerOverlayAlwaysHint = "Если выключено, название, подсказка и кнопки воспроизведения появляются только при движении мыши над визуализацией и затем скрываются.",
        VisualizerResolution = "Разрешение",
        VisualizerResolutionHint = "Меньшее разрешение снижает нагрузку на процессор; изображение масштабируется до размера окна.",
        VisualizerFrameRate = "Частота кадров",
        VisualizerFrameRateHint = "Высокая частота кадров выглядит плавнее, но нагружает процессор.",
        VisualizerAutoAdvance = "Автоматически менять пресеты",
        VisualizerAutoAdvanceHint = "Автоматически показывает следующий пресет через заданное время.",
        VisualizerAutoAdvanceSeconds = "Время показа одного пресета (секунды)",
        VisualizerPresetBlendSeconds = "Длительность плавного перехода между пресетами (секунды)",
        VisualizerPresetBlendSecondsHint = "0 переключает резко; большее значение плавно переводит прежний пресет в новый.",
        VisualizerSelectPresets = "Выбрать пресеты…",
        VisualizerSelectPresetsHint = "Выберите, какие пресеты воспроизводит визуализатор; отключённые пропускаются.",
        VisualizerPresetDownloadHint = "Orynivo не включает чужие пресеты. Коллекции пресетов MilkDrop 2 можно скачать и поместить в папку пресетов.",
        VisualizerDownloadPresets = "Скачать пресеты…",
        VisualizerPresetSelectionTitle = "Пресеты визуализатора",
        VisualizerPresetSelectionHint = "Отключённые пресеты пропускаются при переключении и автоматической смене.",
        VisualizerPresetSelectionAll = "Все",
        VisualizerPresetSelectionNone = "Ничего",
        VisualizerPresetSelectionLoading = "Загрузка пресетов…",
        VisualizerPresetSelectionEmpty = "В этой папке не найдено ни одного пресета.",
        VisualizerPresetSelectionActiveCount = "Активно {0} из {1}",
        MaxOutputSampleRate = "Максимальная частота вывода",
        MaxOutputSampleRateHint = "Ограничивает частоту дискретизации вывода PCM. «Автоматически» использует максимальную частоту устройства; её стоит ограничить, если драйвер заявляет частоту, которую не воспроизводит чисто.",
        MaxOutputSampleRateAutomatic = "Автоматически",
        ResumeOnThisDevice = "Продолжить",
        ResumeOnThisDeviceTooltip = "Продолжить на этом устройстве с {0}",
        ResumeOnThisDeviceHint = "Воспроизведение продолжено с {0}",
        TransportPrevious = "Предыдущий трек",
        TransportPlayPause = "Воспроизвести или пауза",
        TransportNext = "Следующий трек",
        TransportVolume = "Громкость",
        ReduceMotion = "Анимации",
        ReduceMotionHint = "Уменьшает движение в интерфейсе: облако жанров, сцена панели и караоке переключаются без переходов.",
        ReduceMotionEnabled = "Уменьшить движение",
        BackupTarget = "Облачное хранилище резервных копий",
        BackupTargetHint = "Дополнительно сохраняет готовые резервные копии в хранилище WebDAV. Пароль хранится в зашифрованном виде и никогда не записывается в файл настроек.",
        BackupTargetEnabled = "Загружать копии в хранилище WebDAV",
        BackupTargetUrl = "Адрес WebDAV",
        BackupTargetDirectory = "Подпапка (необязательно)",
        BackupTargetUserName = "Имя пользователя (необязательно)",
        BackupTargetPassword = "Пароль (необязательно)",
        BackupUploadDone = "Резервная копия загружена: {0}",
        BackupUploadFailed = "Не удалось загрузить резервную копию.",
        Karaoke = "Караоке",
        ...
        YearInReviewActiveDays = "Активных дней",
        YearInReviewMonthly = "Прослушивание по месяцам",
        YearInReviewTopGenres = "Топ жанров",
        YearInReviewTopAlbums = "Топ альбомов",
        YearInReviewTopArtists = "Топ исполнителей",
        YearInReviewEmpty = "За этот год история прослушивания не записана.",
        SaveAsImage = "Сохранить как изображение…",
        YearInReviewImageSaved = "Изображение сохранено: {0}",
        YearInReviewImageFailed = "Не удалось сохранить изображение.",
        ...
        DuplicateResolutionExact = "Идентичны побайтно",
        DuplicateResolutionLikely = "Вероятные дубликаты",
        DuplicateResolutionSelected = "{0} выбрано для удаления",
        DuplicateResolutionRemove = "Удалить из библиотеки",
        DuplicateResolutionDeleteFiles = "Также удалить файлы с диска",
        DuplicateResolutionConfirmRemove = "Удалить {0} файлов из библиотеки?",
        DuplicateResolutionConfirmDeleteFiles = "Удалить {0} файлов из библиотеки и с диска?",
        DuplicateResolutionNoneFound = "Дублирующиеся файлы не найдены.",
        DuplicateResolutionRemoved = "Из библиотеки удалено {0} файлов.",
...
private static readonly LocalizedStrings ChineseSimplified = new(
        ...
        "发生意外错误。无法保存崩溃报告。Orynivo 即将关闭。")
    {
        ...
        CoverSearchFailed = "无法加载封面。请重试。",
        CoverOriginalLoading = "正在下载原始封面…",
        ...
        BulkGenrePartiallyFailed = "已更新 {0} 首曲目的流派；{1} 首失败。",
        SaveAsPdf = "保存为 PDF…",
        ...
        ScheduledBackupInterval = "间隔天数",
        ScheduledBackupRetention = "保留的备份数量",
        ScheduledBackupFolder = "备份文件夹",
        ChooseFolder = "选择文件夹…",
        RunBackupNow = "立即备份",
        ScheduledBackupLastRun = "上次备份：{0}",
        ScheduledBackupNever = "从未",
        ScheduledBackupRunning = "正在创建备份…",
        ScheduledBackupFinished = "备份已完成。",
        ScheduledBackupFailed = "备份失败。",
        ScheduledBackupDone = "已创建备份：{0}",
        VisualizerPresetFolder = "预设文件夹",
        VisualizerPresetFolderHint = "你可以使用 .oryvis 或 .milk 文件作为自定义预设。仅支持文档中的表达式子集，未知键会被忽略；无法读取的文件将被跳过。",
        VisualizerPresetRejected = "个预设已跳过",
        Visualizer = "可视化",
        VisualizerHint = "空格或单击：下一个预设 · 方向键：上/下一个 · R：重置 · Esc：关闭",
        VisualizerPresetLabel = "预设：{0}",
        VisualizerOverlayAlways = "始终显示文字和控件",
        VisualizerOverlayAlwaysHint = "关闭后，标题、提示和播放按钮仅在鼠标在可视化界面上移动时显示，随后自动隐藏。",
        VisualizerResolution = "分辨率",
        VisualizerResolutionHint = "较低的分辨率更省 CPU；画面会缩放到窗口大小。",
        VisualizerFrameRate = "帧率",
        VisualizerFrameRateHint = "较高的帧率更流畅，但会占用更多 CPU。",
        VisualizerAutoAdvance = "自动切换预设",
        VisualizerAutoAdvanceHint = "在指定时间后自动显示下一个预设。",
        VisualizerAutoAdvanceSeconds = "每个预设的显示时间（秒）",
        VisualizerPresetBlendSeconds = "预设切换交叉淡入淡出时长（秒）",
        VisualizerPresetBlendSecondsHint = "0 表示硬切换；数值越大，上一个预设越平滑地过渡到新预设。",
        VisualizerSelectPresets = "选择预设…",
        VisualizerSelectPresetsHint = "选择可视化播放哪些预设；已停用的预设将被跳过。",
        VisualizerPresetDownloadHint = "Orynivo 不附带第三方预设。可以下载 MilkDrop 2 预设集合并放入预设文件夹。",
        VisualizerDownloadPresets = "下载预设…",
        VisualizerPresetSelectionTitle = "可视化预设",
        VisualizerPresetSelectionHint = "切换预设和自动切换时会跳过已停用的预设。",
        VisualizerPresetSelectionAll = "全部",
        VisualizerPresetSelectionNone = "无",
        VisualizerPresetSelectionLoading = "正在加载预设…",
        VisualizerPresetSelectionEmpty = "此文件夹中未找到任何预设。",
        VisualizerPresetSelectionActiveCount = "{1} 个中有 {0} 个启用",
        MaxOutputSampleRate = "最大输出采样率",
        MaxOutputSampleRateHint = "限制 PCM 输出采样率。“自动”使用设备提供的最高采样率；当驱动程序声称支持某个采样率但无法干净重放时，有限制更好。",
        MaxOutputSampleRateAutomatic = "自动",
        ResumeOnThisDevice = "继续",
        ResumeOnThisDeviceTooltip = "在此设备上从 {0} 继续",
        ResumeOnThisDeviceHint = "已从 {0} 继续",
        TransportPrevious = "上一曲",
        TransportPlayPause = "播放或暂停",
        TransportNext = "下一曲",
        TransportVolume = "音量",
        ReduceMotion = "动画",
        ReduceMotionHint = "减少界面中的运动：风格云、仪表板展台和卡拉OK 将无过渡地切换。",
        ReduceMotionEnabled = "减少运动",
        BackupTarget = "云备份目标",
        BackupTargetHint = "同时将已完成的备份保存到 WebDAV 存储。密码以加密方式保存，绝不写入设置文件。",
        BackupTargetEnabled = "将备份上传到 WebDAV 目标",
        BackupTargetUrl = "WebDAV 地址",
        BackupTargetDirectory = "子文件夹（可选）",
        BackupTargetUserName = "用户名（可选）",
        BackupTargetPassword = "密码（可选）",
        BackupUploadDone = "备份已上传：{0}",
        BackupUploadFailed = "备份上传失败。",
        Karaoke = "卡拉OK",
        ...
        YearInReviewActiveDays = "活跃天数",
        YearInReviewMonthly = "每月收听",
        YearInReviewTopGenres = "热门流派",
        YearInReviewTopAlbums = "热门专辑",
        YearInReviewTopArtists = "热门艺术家",
        YearInReviewEmpty = "该年度没有记录收听历史。",
        SaveAsImage = "保存为图片…",
        YearInReviewImageSaved = "图片已保存：{0}",
        YearInReviewImageFailed = "无法保存图片。",
        ...
        DuplicateResolutionExact = "字节完全相同",
        DuplicateResolutionLikely = "可能重复",
        DuplicateResolutionSelected = "已选择 {0} 个要移除",
        DuplicateResolutionRemove = "从资料库中移除",
        DuplicateResolutionDeleteFiles = "同时从磁盘删除文件",
        DuplicateResolutionConfirmRemove = "从资料库中移除 {0} 个文件？",
        DuplicateResolutionConfirmDeleteFiles = "从资料库中移除 {0} 个文件并从磁盘删除？",
        DuplicateResolutionNoneFound = "未找到重复文件。",
        DuplicateResolutionRemoved = "已从资料库中移除 {0} 个文件。",
    ...
    private static readonly LocalizedStrings Hindi = new(
        ...
        "+ फ़ोल्डर जोड़ें",
        "डेटाबेस रखरखाव",
        "डेटाबेस अनुकूलित करें",
        "एल्बम कवर सुधारें",
        "अनुपलब्ध कवर डाउनलोड करें",
        "स्वचालित डाउनलोड केवल MusicBrainz ID वाले कवर ढूँढ़ता है। अधिक लचीली खोज के लिए एल्बम दृश्य में दिए गए बटन का उपयोग करें।",
        "कवर नहीं मिला",
        "कवर खोजें",
        "कवर खोजें",
        "मिलते-जुलते कवर खोजे जा रहे हैं …",
        "कोई कवर नहीं मिला।",
        "एल्बम खोज शब्द",
        "कलाकार (वैकल्पिक)",
        "फिर खोजें",
        "चुना हुआ कवर उपयोग करें",
        "कवर हटाएँ",
        "कवर बदलें",
        "लेखक",
        "लाइसेंस",
        ...
        "अवधि",
        "प्रारूप",
        "ट्रैक में खोज शब्द {0} नहीं मिला।",
        "एल्बम में खोज शब्द {0} नहीं मिला।",
        "कलाकारों में खोज शब्द {0} नहीं मिला।",
        "{0:N0} प्रविष्टियाँ",
        "{0:N0} ट्रैक",
        "कृपया पहले किसी ट्रैक पर डबल-क्लिक करें।",
        "प्लेबैक रोक दिया गया।",
        "प्लेबैक पूरा हुआ।",
        "कृपया पहले सेटिंग्स में ASIO डिवाइस चुनें।",
        "कृपया पहले सेटिंग्स में WASAPI डिवाइस चुनें।",
        "{0} अभी उपलब्ध नहीं है।",
        "सेटिंग्स सहेजी गईं।",
        "डिवाइस की जानकारी नहीं पढ़ी जा सकी: {0}",
        "कोई सक्रिय WASAPI आउटपुट डिवाइस नहीं मिला।",
        "कोई ASIO ड्राइवर नहीं मिला।",
        "डिवाइस चुनें और सहेजें।",
        "स्कैन हो रहा है…",
        "फ़ोल्डर नहीं मिला।",
        "स्कैन रद्द कर दिया गया।",
        "डेटाबेस अनुकूलित हो रहा है …",
        "अनुकूलन पूरा हुआ।",
        "अनुकूलन विफल: {0}",
        "एल्बम कवर सुधारे जा रहे हैं …",
        "{0:N0} एल्बम कवर सुधारे गए।",
        "कवर सुधार विफल: {0}",
        "अनुपलब्ध कवर डाउनलोड हो रहे हैं …",
        "{0:N0} अनुपलब्ध कवर डाउनलोड किए गए।",
        "कवर डाउनलोड विफल: {0}",
        ...
        "प्लेलिस्ट का नाम",
        "बनाएँ",
        "ट्रैक प्लेलिस्ट '{0}' में जोड़ा गया।",
        "{0} ट्रैक प्लेलिस्ट '{1}' में जोड़े गए।",
        "प्लेलिस्ट हटाएँ",
        "प्लेलिस्ट से हटाएँ",
        "प्लेलिस्ट '{0}' हटा दी गई।",
        "ट्रैक प्लेलिस्ट से हटा दिया गया।",
        "फ़िल्टर को स्मार्ट प्लेलिस्ट के रूप में सहेजें",
        "स्मार्ट प्लेलिस्ट '{0}' सहेजी गई।",
        "कृपया पहले कोई फ़िल्टर चुनें।",
        "संग्रह का बैकअप",
        "डेटाबेस, प्लेलिस्ट, इतिहास, कवर और फ़ोल्डर सूची को ZIP के रूप में निर्यात करता है। ऑडियो फ़ाइलें शामिल नहीं हैं।",
        "संग्रह निर्यात करें",
        "संग्रह आयात करें",
        "संग्रह निर्यात हो रहा है …",
        "संग्रह '{0}' में निर्यात किया गया।",
        "संग्रह निर्यात विफल: {0}",
        "आयात वर्तमान संग्रह, प्लेलिस्ट, इतिहास और सभी कवर बदल देगा। जारी रखें?",
        "संग्रह आयात और खोज सूचकांक का पुनर्निर्माण हो रहा है …",
        "संग्रह आयात हो गया। Orynivo अब बंद होगा; फिर इसे पुनः शुरू किया जा सकता है।",
        "संग्रह आयात विफल: {0}",
        "कृपया पहले सक्रिय संग्रह स्कैन या रखरखाव पूरा करें।",
        "Orynivo संग्रह (*.zip)|*.zip",
        "संग्रह निर्यात: {0}% – {1}",
        "संग्रह आयात: {0}% – {1}",
        "गीत के बोल",
        "गीत के बोल दिखाएँ",
        "गीत के बोल रीफ़्रेश करें",
        "गीत के बोल बंद करें",
        "गीत के बोल लोड हो रहे हैं …",
        "LRCLIB से गीत के बोल डाउनलोड हो रहे हैं …",
        "इस ट्रैक के लिए मेटाडेटा उपलब्ध नहीं है।",
        "गीत के बोल नहीं मिले।",
        "गीत के बोल डाउनलोड नहीं किए जा सके।",
        "कलाकार की जानकारी",
        "कलाकार की जानकारी दिखाएँ",
        "कलाकार की जानकारी रीफ़्रेश करें",
        "कलाकार की जानकारी बंद करें",
        "कलाकार की जानकारी लोड हो रही है …",
        "कलाकार की जानकारी डाउनलोड हो रही है …",
        "कलाकार की जानकारी नहीं मिली।",
        "कलाकार की जानकारी डाउनलोड नहीं की जा सकी।",
        "कोई चित्र डाउनलोड नहीं हुआ",
        "चित्र फ़ाइल अनुपलब्ध है",
        "चित्र लोड नहीं हुआ",
        "स्रोत: Wikipedia",
        "स्रोत: Last.fm",
        ...
        "स्थानीय संग्रह और सभी कॉन्फ़िगर किए गए Orynivo सर्वर में क्रम से खोजता है। हर कलाकार के लिए पहले Fanart.tv (API कुंजी के साथ), फिर Wikimedia आज़माता है। Fanart.tv परिणाम स्वतः स्वीकार किए जा सकते हैं; Wikimedia परिणामों की हमेशा पुष्टि ज़रूरी है।",
        "कलाकार चित्र {0}/{1} खोजा जा रहा है: {2} · {3}",
        "{0:N0} कलाकार चित्र स्वीकार किए गए, {1:N0} अस्वीकार किए गए; {2:N0} अनुरोध विफल।",
        "कलाकार चित्र डाउनलोड विफल: {0}",
        "कलाकार चित्र डाउनलोड रद्द कर दिया गया।",
        "सुझाव {0}/{1}: {2} · {3}",
        "स्थानीय और सर्वर के कलाकार लोड हो रहे हैं …",
        "शेष समय का अनुमान लगाया जा रहा है …",
        "अनुमानित शेष समय: {0}",
        "कलाकार चित्र का सुझाव",
        "स्रोत: {0}",
        "यह चित्र आपकी पुष्टि के बाद ही सहेजा जाएगा।",
        "स्वीकार करें",
        "अस्वीकार करें",
        "एल्बम के सभी ट्रैक दिखाएँ",
        "Orynivo क्रैश हो गया",
        "एक अप्रत्याशित त्रुटि हुई। क्रैश रिपोर्ट यहाँ सहेजी गई है:\n\n{0}\n\nOrynivo अब बंद होगा।",
        "एक अप्रत्याशित त्रुटि हुई। क्रैश रिपोर्ट सहेजी नहीं जा सकी। Orynivo अब बंद होगा।")
    {
        TrackInfo = "ट्रैक की जानकारी",
        ShowTrackInfo = "ट्रैक की जानकारी दिखाएँ",
        PhysicalPath = "वास्तविक फ़ाइल पथ",
        ReleaseOutputDevice = "आउटपुट डिवाइस मुक्त करें",
        ReacquireOutputDevice = "आउटपुट डिवाइस फिर प्राप्त करें और प्लेबैक जारी रखें",
        OutputDeviceReleased = "आउटपुट डिवाइस मुक्त है",
        VersionLabel = "संस्करण {0}",
        CheckForUpdates = "अपडेट जाँचें",
        Updates = "अपडेट",
        CheckForUpdatesOnStartup = "ऐप शुरू होने पर अपडेट जाँचें",
        WindowBehavior = "विंडो व्यवहार",
        StartMaximized = "अधिकतम आकार में शुरू करें",
        CheckingForUpdates = "अपडेट जाँचे जा रहे हैं…",
        UpdateAvailable = "संस्करण {0} उपलब्ध है।",
        UpToDate = "Orynivo अद्यतित है।",
        UpdateUnavailable = "इस बिल्ड के लिए सत्यापित अपडेट कॉन्फ़िगर नहीं हैं।",
        DownloadAndInstall = "डाउनलोड और इंस्टॉल करें",
        DownloadingUpdate = "अपडेट डाउनलोड और सत्यापित हो रहा है…",
        InstallingUpdate = "अपडेट इंस्टॉल हो रहा है…",
        UpdateFailed = "अपडेट जाँचा या इंस्टॉल नहीं किया जा सका।",
        UpdateServer = "सर्वर अपडेट करें",
        UpdatingServer = "अपडेट भेजा जा रहा है…",
        ServerUpdateQueued = "अपडेट शुरू हुआ",
        ServerUpdateUnavailable = "कोई नया समर्थित सर्वर अपडेट उपलब्ध नहीं है।",
        ServerUpdateFailed = "सर्वर अपडेट विफल",
        ServerUpdateRejected = "सर्वर ने अपडेट अस्वीकार किया (HTTP {0})",
        UpdatingNamedServer = "सर्वर '{0}' अपडेट हो रहा है…",
        ServerUpdatesFailedContinue = "इन सर्वर को अपडेट नहीं किया जा सका: {0}। डेस्कटॉप अपडेट जारी रखें?",
        OutputType = "आउटपुट प्रकार",
        LocalMedia = "स्थानीय",
        AsioOutputDevice = "ASIO आउटपुट डिवाइस",
        CwAsioOutputDevice = "cwASIO आउटपुट डिवाइस",
        SteinbergAsio = "Steinberg ASIO",
        CwAsio = "cwASIO",
        WasapiOutputDevice = "WASAPI आउटपुट डिवाइस",
        AirPlay = "AirPlay 2",
        AirPlayOutputDevice = "AirPlay 2 आउटपुट डिवाइस",
        NoAirPlayDevices = "स्थानीय नेटवर्क पर कोई AirPlay 2 डिवाइस नहीं मिला।",
        AirPlaySenderMissing = "नेटिव AirPlay 2 ब्रिज अनुपलब्ध है; विकल्प के रूप में संगत “raop_play” सहायक उपयोग किया जा सकता है।",
        SelectAirPlayDevice = "पहले AirPlay आउटपुट डिवाइस चुनें।",
        OpenAl = "OpenAL",
        OpenAlOutputDevice = "OpenAL आउटपुट डिवाइस",
        DirectAlsa = "ALSA (सीधा, एक्सक्लूसिव)",
        AlsaOutputDevice = "सीधा ALSA आउटपुट डिवाइस",
        LinuxDefaultAudioDevice = "सिस्टम डिफ़ॉल्ट (OpenAL)",
        OpenAlInitializationFailed = "OpenAL सिस्टम ऑडियो आउटपुट आरंभ नहीं कर सका।",
        AlsaExactOpenFailed = "बिना रीसैंपलिंग के ALSA डिवाइस “{0}” को {1} Hz पर नहीं खोला जा सकता: {2}",
        AlsaDeviceBusy = "सीधा ALSA डिवाइस “{0}” पहले से PipeWire या किसी अन्य ऐप के उपयोग में है। सिस्टम आउटपुट बदलने से डिवाइस मुक्त नहीं होता। सिस्टम में साउंड डिवाइस प्रोफ़ाइल अक्षम करें या OpenAL आउटपुट चुनें।",
        AlsaPrepareFailed = "सीक करने के बाद ALSA आउटपुट डिवाइस तैयार नहीं कर सका।",
        DeviceInfo = "डिवाइस की जानकारी",
        DatabaseOptimizeHint = "खाली पृष्ठ हटा दिए जाते हैं ताकि फ़ाइल का वास्तविक आकार छोटा हो जाए।",
        GenreCloudCache = "शैली क्लाउड की पृष्ठभूमियाँ",
        GenreCloudCacheHint = "कैश में रखे कलाकार मोज़ेक हटाएँ। अगली बार शैली स्तर खोलने पर वे फिर बनेंगे।",
        GenreCloudCacheCleared = "शैली क्लाउड का पृष्ठभूमि कैश हटा दिया गया।",
        GenreCloudBackground = "शैली क्लाउड",
        GenreCloudBackgroundHint = "पृष्ठभूमि चित्र चुनें या सिस्टम पर भार कम करने के लिए उन्हें पूरी तरह बंद करें।",
        GenreCloudBackgroundNone = "कोई पृष्ठभूमि चित्र नहीं",
        GenreCloudBackgroundAlbums = "एल्बम कवर",
        GenreCloudBackgroundArtists = "कलाकार चित्र",
        GenreCloudVisibility = "चित्र की दृश्यता",
        ClearGenreCloudCache = "पृष्ठभूमि कैश हटाएँ",
        AppearanceNavItem = "दिखावट",
        ArtistInfoNavItem = "कलाकार की जानकारी",
        NormalizeArtists = "कलाकार नाम सामान्यीकृत करें",
        NormalizeArtistsHint = "मुख्य कलाकार से “feat.” जैसे जोड़ हटाता है और स्पष्ट विराम-चिह्न व स्पेसिंग भिन्नताएँ मिलाता है। ऑडियो फ़ाइलें नहीं बदलतीं।",
        ArtistsNormalizing = "कलाकार नाम सामान्यीकृत और खोज सूचकांक पुनर्निर्मित हो रहा है …",
        ArtistsNormalized = "कलाकार नाम के {0:N0} रूप मिलाए और {1:N0} ट्रैक अपडेट किए गए।",
        ArtistNormalizationFailed = "कलाकार सामान्यीकरण विफल: {0}",
        AsioBridgeMissing = "इस बिल्ड में ASIO समर्थन नहीं है। कृपया WASAPI उपयोग करें।",
        KernelStreamingUnavailable = "Kernel Streaming चुना जा सकता है, लेकिन प्लेबैक बैकएंड के रूप में अभी उपलब्ध नहीं है।",
        AddMusicDirectory = "संगीत फ़ोल्डर जोड़ें",
        TrackCountTooltip = "डेटाबेस में ट्रैक की संख्या",
        Scan = "स्कैन करें",
        RefreshAllMetadata = "मेटाडेटा फिर पढ़ें",
        RefreshAllMetadataHint = "हर फ़ाइल का मेटाडेटा फिर पढ़ता है, भले ही उसका टाइमस्टैम्प न बदला हो। इसमें काफ़ी अधिक समय लग सकता है।",
        RemoveDirectory = "फ़ोल्डर हटाएँ",
        ScanCompleted = "पूरा हुआ: {0} फ़ाइलें · {1} नई · {2} अपडेट · {3} हटाई गईं{4}",
        ScanFailed = "त्रुटि: {0}",
        StartupPreparingLibrary = "संग्रह तैयार हो रहा है …",
        StartupCheckingSearchIndex = "खोज सूचकांक जाँचा जा रहा है …",
        SearchIndexRebuilding = "पृष्ठभूमि में खोज सूचकांक फिर बन रहा है ({0}/{1}) …",
        SearchIndexReady = "खोज सूचकांक अद्यतित है।",
        SearchIndexFailed = "खोज सूचकांक अपडेट नहीं किया जा सका: {0}",
        Back = "वापस",
        MarkAsFavorite = "पसंदीदा चिह्नित करें",
        OpenAlbum = "एल्बम खोलें",
        OpenArtist = "कलाकार खोलें",
        ToggleFavorite = "पसंदीदा बदलें",
        PlaybackThrough = "{0} के माध्यम से प्लेबैक",
        PlaybackThroughWithDsdConversion = "{0} के माध्यम से प्लेबैक · DSD को PCM में बदला जा रहा है ({1:N0} Hz)",
        NativeDsdOutput = "नेटिव DSD",
        DsdToPcmOutput = "DSD → PCM",
        DopOutput = "DoP के माध्यम से DSD",
        DopRequiresDirectAlsa = "Linux पर DoP के माध्यम से DSD के लिए बिना रीसैंपलिंग वाला सीधा ALSA आउटपुट डिवाइस चाहिए।",
        ReplayGain = "ReplayGain वॉल्यूम समायोजन",
        ReplayGainHint = "PCM प्लेबैक पर लागू होता है। ट्रैक मोड ट्रैक गेन को और एल्बम मोड एल्बम गेन को प्राथमिकता देता है। नेटिव DSD आउटपुट बिट-परफ़ेक्ट रहता है।",
        ReplayGainOff = "बंद",
        ReplayGainTrack = "ट्रैक",
        ReplayGainAlbum = "एल्बम",
        CalculateReplayGainDuringScan = "स्थानीय संग्रह स्कैन के दौरान अनुपलब्ध ReplayGain स्वतः गणना करें (धीमा)",
        CalculateReplayGain = "अनुपलब्ध ReplayGain की गणना करें",
        ReplayGainCalculating = "ReplayGain की गणना हो रही है …",
        ReplayGainCalculated = "ReplayGain की गणना हुई: {0} ट्रैक अपडेट किए गए।",
        ReplayGainCalculationFailed = "ReplayGain की गणना विफल: {0}",
        NonGaplessCrossfade = "गैपलेस के बिना कतारों के लिए फ़ेड (सेकंड)",
        NonGaplessCrossfadeHint = "0 संक्रमण बंद करता है। केवल उन कतार परिवर्तनों पर लागू होता है जिन्हें गैपलेस PCM इंजन पहले से नहीं सँभालता।",
        ReplayGainBadge = "RG",
        DsdPlayback = "DSD प्लेबैक",
        AlwaysConvertDsdToPcm = "DSD फ़ाइलों को हमेशा PCM में बदलें",
        AlwaysConvertDsdToPcmHint = "ASIO/cwASIO के साथ भी PCM पथ उपयोग करता है, जिससे वॉल्यूम, ReplayGain और इक्वलाइज़र लागू हो सकते हैं। यह विकल्प बंद होने पर नेटिव DSD आउटपुट बिट-परफ़ेक्ट रहता है।",
        DsdOverPcm = "DoP के माध्यम से DSD आउटपुट दें",
        DsdOverPcmHint = "DSD को बिट-परफ़ेक्ट रूप में PCM फ़्रेम में रखता है (DSD over PCM)। DoP-सक्षम DAC और बिना रीसैंपलिंग का सटीक आउटपुट चाहिए; वॉल्यूम, ReplayGain और इक्वलाइज़र का कोई प्रभाव नहीं होता।",
        PcmOutputBoost = "PCM आउटपुट में +6 dB बढ़ाएँ",
        PcmOutputBoostHint = "सभी PCM प्लेबैक पथों का स्तर बढ़ाता है ताकि उनकी ध्वनि नेटिव DSD आउटपुट के करीब हो। नेटिव DSD आउटपुट बिट-परफ़ेक्ट और अपरिवर्तित रहता है।",
        OutputDevicesLoading = "आउटपुट डिवाइस लोड हो रहे हैं …",
        Equalizer = "पैरामेट्रिक इक्वलाइज़र",
        EqualizerHint = "PCM और DSD-से-PCM प्लेबैक के लिए Equalizer APO और AutoEQ प्रोफ़ाइल आयात करता है। नेटिव DSD आउटपुट बिट-परफ़ेक्ट रहता है।",
        EqualizerEnabled = "इक्वलाइज़र सक्षम करें",
        EqualizerImport = "APO/AutoEQ प्रोफ़ाइल आयात करें",
        EqualizerImporting = "इक्वलाइज़र प्रोफ़ाइल आयात हो रही है …",
        EqualizerImportTitle = "Equalizer APO या AutoEQ प्रोफ़ाइल आयात करें",
        EqualizerNoProfile = "कोई प्रोफ़ाइल आयात नहीं हुई।",
        EqualizerProfileSummary = "{0} · प्रीऐम्प {1:+0.##;-0.##;0} dB · {2} फ़िल्टर",
        EqualizerImportFailed = "प्रोफ़ाइल आयात नहीं की जा सकी।",
        EqualizerProfileFileType = "Equalizer APO / AutoEQ प्रोफ़ाइल",
        EqualizerPreamp = "प्रीऐम्प (dB)",
        EqualizerFilterType = "फ़िल्टर प्रकार",
        EqualizerFrequency = "आवृत्ति (Hz)",
        EqualizerGain = "गेन (dB)",
        EqualizerQ = "Q गुणांक",
        EqualizerAddFilter = "फ़िल्टर जोड़ें",
        EqualizerRemoveFilter = "फ़िल्टर हटाएँ",
        EqualizerPeak = "पीक",
        EqualizerLowShelf = "लो शेल्फ़",
        EqualizerHighShelf = "हाई शेल्फ़",
        EqualizerLowPass = "लो पास",
        EqualizerHighPass = "हाई पास",
        EqualizerCreate = "इक्वलाइज़र बनाएँ",
        EqualizerCreateTitle = "नया इक्वलाइज़र बनाएँ",
        EqualizerName = "इक्वलाइज़र का नाम",
        EqualizerNameExists = "इस नाम का इक्वलाइज़र पहले से मौजूद है।",
        OutputProfile = "आउटपुट",
        OutputProfileCreate = "आउटपुट बनाएँ",
        OutputProfileConfigure = "आउटपुट कॉन्फ़िगर करें",
        OutputProfileDelete = "आउटपुट हटाएँ",
        OutputProfileCreateTitle = "नया आउटपुट बनाएँ",
        OutputProfileConfigureTitle = "आउटपुट कॉन्फ़िगर करें",
        OutputProfileName = "आउटपुट का नाम",
        OutputProfileNameExists = "इस नाम का आउटपुट पहले से मौजूद है।",
        OutputProfileDeleteTitle = "आउटपुट हटाएँ",
        OutputProfileDeleteConfirm = "क्या आप वाकई आउटपुट “{0}” हटाना चाहते हैं?",
        UserProfiles = "उपयोगकर्ता प्रोफ़ाइल",
        UserProfileActive = "सक्रिय प्रोफ़ाइल",
        UserProfileCreate = "प्रोफ़ाइल बनाएँ",
        UserProfileRename = "प्रोफ़ाइल का नाम बदलें",
        UserProfileDelete = "प्रोफ़ाइल हटाएँ",
        UserProfileName = "प्रोफ़ाइल का नाम",
        UserProfileMigrateFavorites = "मौजूदा निजी डेटा (पसंदीदा, रेटिंग और इतिहास) नई प्रोफ़ाइल में कॉपी करें?",
        UserProfileDeleteConfirm = "प्रोफ़ाइल “{0}” हटाएँ?",
        EqualizerDelete = "इक्वलाइज़र हटाएँ",
        EqualizerDeleteTitle = "इक्वलाइज़र हटाएँ",
        EqualizerDeleteConfirm = "क्या आप वाकई इक्वलाइज़र “{0}” हटाना चाहते हैं?",
        SelectColumns = "कॉलम चुनें",
        FileName = "फ़ाइल का नाम",
        FileSize = "फ़ाइल का आकार",
        AddedAt = "जोड़ने की तारीख",
        SampleRate = "सैंपल दर",
        BitDepth = "बिट गहराई",
        Channels = "चैनल",
        TrackNumber = "ट्रैक संख्या",
        DiscNumber = "डिस्क संख्या",
        Composer = "संगीतकार",
        Bpm = "BPM",
        ReplayGainTrackColumn = "ट्रैक ReplayGain",
        ReplayGainAlbumColumn = "एल्बम ReplayGain",
        PersonalRating = "मेरी रेटिंग",
        MusicBrainzRating = "MusicBrainz रेटिंग",
        MusicBrainzLoadRating = "रेटिंग लोड करें",
        MusicBrainzLoadingRating = "लोड हो रहा है …",
        MusicBrainzRetryRating = "फिर कोशिश करें",
        MusicBrainzNoRating = "रेटिंग नहीं है",
        RatingSetHint = "निजी रेटिंग सेट करें",
        RatingUpdateFailed = "रेटिंग सहेजी नहीं जा सकी।",
        Codec = "कोडेक",
        Tags = "टैग",
        Homepage = "वेबसाइट",
        FeedUrl = "फ़ीड का पता",
        SearchResultSummary = "{0:N0} ट्रैक · {1:N0} एल्बम · {2:N0} कलाकार",
        RecentAlbums = "हाल में जोड़े गए एल्बम",
        AlbumRecommendations = "एल्बम सुझाव",
        RecommendationMoodAll = "सभी मूड",
        RecommendationMoodRelaxed = "सुकून भरा",
        RecommendationMoodEnergetic = "ऊर्जावान",
        RecommendationMoodHappy = "खुशनुमा",
        RecommendationMoodMelancholic = "उदास",
        RecommendationNoMatches = "सुझावों के लिए अभी पर्याप्त मेल खाता सुनने का इतिहास नहीं है।",
        PlayMoreLikeThis = "ऐसे और ट्रैक चलाएँ",
        PlayMoodMix = "मूड मिक्स",
        SimilarTracksLoading = "मिलते-जुलते ट्रैक लोड हो रहे हैं …",
        SimilarTracksUnavailable = "इस ट्रैक के लिए समानता डेटा उपलब्ध नहीं है।",
        SimilarTracksNoMatches = "कोई मिलता-जुलता ट्रैक नहीं मिला।",
        SimilarTracksQueued = "{0:N0} मिलते-जुलते ट्रैक चलाने के लिए तैयार हैं।",
        RecommendationListView = "सूची",
        RecommendationStageView = "मंच",
        MetadataProblems = "मेटाडेटा की समीक्षा करें",
        MetadataProblemsHint = "Orynivo वास्तविक फ़ोल्डर की समीक्षा करता है, भले ही एल्बम आवंटन बिखरे हुए हों। मिलती-जुलती MusicBrainz रिलीज़ खोजने के लिए प्रविष्टि पर डबल-क्लिक करें।",
        MetadataWorkflow = "1. निष्कर्ष देखें   →   2. फ़ोल्डर चुनें   →   3. प्रस्ताव की तुलना और पुष्टि करें",
        MetadataNoFindings = "चुने हुए फ़िल्टर के लिए अभी कोई निष्कर्ष नहीं है।",
        MetadataInspectFiles = "फ़ाइलें भी जाँचें (पठनीयता और डुप्लिकेट चेकसम; धीमा)",
        MetadataQuickHint = "यह पृष्ठ खोलने पर संगीत फ़ाइलें पढ़े बिना सहेजा गया मेटाडेटा जाँचा जाता है। वास्तविक फ़ाइलें जाँचने के लिए विकल्प सक्षम करें और विश्लेषण रीफ़्रेश करें। त्वरित समीक्षा के लिए पुराने सर्वर अपडेट करें।",
        MetadataSelectHint = "फ़ोल्डर चुनें। विश्लेषण कुछ बदलता नहीं और कोई फ़ाइल नहीं हटाता।",
        MetadataActionGuide = "“फ़ोल्डर को एल्बम के रूप में पहचानें” MusicBrainz पर शीर्षक, कलाकार और क्रमांक खोजता है। अनुपलब्ध ReplayGain: सेटिंग्स → प्लेबैक। चित्र: एल्बम/कलाकार दृश्य। अनुपलब्ध फ़ाइलें और डुप्लिकेट स्वयं जाँचें। केवल पुष्टि किए गए बदलाव संग्रह में सहेजे जाते हैं; ऑडियो फ़ाइलें नहीं बदलतीं।",
        MetadataRemoteReadOnly = "यह सर्वर प्रविष्टि केवल-पढ़ने योग्य रिपोर्ट है। MusicBrainz फ़ोल्डर सुधार केवल स्थानीय प्रविष्टियों के लिए उपलब्ध है। Orynivo सर्वर में ReplayGain की गणना करें; एल्बम/कलाकार दृश्य में चित्र जोड़ें।",
        MetadataReviewGuide = "आपके वर्तमान ट्रैक ऊपर हैं। नीचे रिलीज़ चुनें और पूर्वावलोकन की पंक्ति-दर-पंक्ति तुलना करें। खोज शब्द संपादित किए जा सकते हैं। केवल “सुधार लागू करें” संग्रह में बदलाव सहेजता है।",
        MetadataPhaseDatabase = "सहेजा गया मेटाडेटा लोड हो रहा है…",
        MetadataPhaseFolders = "फ़ोल्डर और मेटाडेटा की समीक्षा हो रही है…",
        MetadataPhaseHashes = "संभावित डुप्लिकेट फ़ाइलों के हैश बन रहे हैं…",
        MetadataPhaseServers = "सर्वर रिपोर्ट की प्रतीक्षा है। सर्वर समय का अनुमान नहीं देता; पूरे हो चुके निष्कर्ष उपलब्ध हैं।",
        MetadataPhaseReleases = "MusicBrainz रिलीज़ और ट्रैक सूची लोड हो रही हैं…",
        MetadataPhaseSaving = "पुष्टि किया गया सुधार सहेजा और खोज सूचकांक अपडेट किया जा रहा है…",
        MetadataRemaining = "इस चरण में अनुमानित शेष समय: {0}",
        MetadataRemainingUnknown = "शेष समय का अभी अनुमान नहीं लगाया जा सकता",
        MetadataElapsed = "बीता समय: {0}",
        IdentifyFolderAsAlbum = "फ़ोल्डर को एल्बम के रूप में पहचानें",
        MetadataFolder = "फ़ोल्डर",
        MetadataIssues = "मिली समस्याएँ",
        MetadataTrackCount = "ट्रैक",
        MetadataReviewTitle = "एल्बम मेटाडेटा की समीक्षा करें",
        MetadataSearching = "ट्रैक संख्या और अवधि के आधार पर MusicBrainz में खोज हो रही है…",
        MetadataNoMatch = "पर्याप्त मेल खाती रिलीज़ नहीं मिली।",
        MetadataSearchFailed = "MusicBrainz अभी उपलब्ध नहीं है। कृपया फिर खोजें।",
        MetadataFoundReleases = "मेल खाती रिलीज़",
        MetadataApplyCorrection = "सुधार लागू करें",
        MetadataCorrectionPreview = "सुधार का पूर्वावलोकन",
        MetadataCurrentValues = "वर्तमान: शीर्षक — कलाकार",
        MetadataProposedValues = "प्रस्तावित: शीर्षक — कलाकार",
        MetadataRefreshAnalysis = "विश्लेषण रीफ़्रेश करें",
        MetadataAlbumQuery = "एल्बम खोज शब्द",
        MetadataArtistQuery = "कलाकार खोज शब्द",
        MetadataRepairSuccess = "Orynivo के संग्रह में मेटाडेटा सुधार दिया गया।",
        MetadataIssueAlbums = "असंगत एल्बम शीर्षक",
        MetadataIssueArtists = "असंगत एल्बम कलाकार",
        MetadataIssueMissingTitles = "अनुपलब्ध ट्रैक शीर्षक",
        MetadataIssueMissingNumbers = "अनुपलब्ध ट्रैक क्रमांक",
        MetadataIssueDuplicateNumbers = "दोहराए गए ट्रैक क्रमांक",
        MetadataIssueMissingReplayGain = "{0} में ReplayGain नहीं है",
        MetadataIssueMissingMusicBrainzIds = "{0} में MusicBrainz ID नहीं है",
        MetadataSeverity = "प्राथमिकता",
        MetadataSeverityAll = "सभी प्राथमिकताएँ",
        MetadataIssueAll = "सभी निष्कर्ष प्रकार",
        MetadataIssueReplayGain = "ReplayGain अनुपलब्ध",
        MetadataIssueMusicBrainzIds = "MusicBrainz ID अनुपलब्ध",
        MetadataIssueIncompleteAlbum = "अधूरा एल्बम ({0} ट्रैक अनुपलब्ध)",
        MetadataIssueAlbumArtwork = "एल्बम कवर अनुपलब्ध",
        MetadataIssueArtistImage = "कलाकार चित्र अनुपलब्ध",
        MetadataIssueMissingFiles = "{0} स्रोत फ़ाइलें अनुपलब्ध",
        MetadataIssueUnreadableFiles = "{0} स्रोत फ़ाइलें अपठनीय",
        MetadataIssueLikelyDuplicates = "{0} संभावित डुप्लिकेट फ़ाइलें",
        MetadataIssueExactDuplicates = "{0} बाइट-समान डुप्लिकेट फ़ाइलें",
        MetadataIssueAlternateRecordings = "{0} रिकॉर्डिंग किसी अन्य फ़ाइल या संस्करण में",
        MetadataIssueArtistNameVariants = "कलाकार नामों की {0} वैकल्पिक वर्तनियाँ",
        MetadataSeverityInformation = "जानकारी",
        MetadataSeverityWarning = "चेतावनी",
        MetadataSeverityError = "त्रुटि",
        MetadataDoctorSummary = "{0} त्रुटियाँ · {1} चेतावनियाँ · {2} सूचनाएँ",
        MetadataAnalysisFailed = "विश्लेषण विफल। विवरण त्रुटि लॉग में सहेजा गया।",
        MetadataDoctorServersUnavailable = "{0} सर्वर अनुपलब्ध हैं या अभी Library Doctor समर्थित नहीं करते",
        MetadataAnalysisCancelled = "विश्लेषण रद्द कर दिया गया।",
        Calendar = "कैलेंडर – {0}",
        TopGenres = "सबसे अधिक सुनी गई शैलियाँ",
        TopAlbums = "सबसे अधिक सुने गए एल्बम (मिनटों में)",
        TopArtists = "सबसे अधिक सुने गए कलाकार",
        ListeningStats = "सुनने के आँकड़े",
        PeriodAllTime = "अब तक",
        PeriodThisYear = "इस वर्ष",
        PeriodThisMonth = "इस महीने",
        PeriodLast30Days = "पिछले 30 दिन",
        PeriodLast7Days = "पिछले 7 दिन",
        HistorySourceRemote = "रिमोट",
        HistorySourcePlex = "Plex",
        NoData = "डेटा उपलब्ध नहीं है।",
        LibraryUpdating = "संग्रह अपडेट हो रहा है…",
        LibraryUpdatingWithCount = "संग्रह अपडेट हो रहा है… {0} / {1} फ़ाइलें",
        RefreshView = "रीफ़्रेश करें",
        LibraryDataAvailable = "संग्रह का नया डेटा उपलब्ध है",
        ServerUnreachable = "पहुँच से बाहर",
        ServerLastConnected = "अंतिम कनेक्शन: {0}",
        ServerNeverConnected = "कभी कनेक्ट नहीं हुआ",
        ServerMissingFeatures = "सर्वर समर्थित नहीं करता: {0}",
        CapabilityTrackFacets = "ट्रैक फ़िल्टर",
        CapabilityRecentAlbums = "हाल के एल्बम",
        CapabilityWaveforms = "वेवफ़ॉर्म",
        RemoteCache = "रिमोट कैश",
        RemoteCacheSize = "कैश आकार: {0}",
        ClearRemoteCacheAll = "पूरा कैश हटाएँ",
        ClearCache = "कैश हटाएँ",
        RemoteScanning = "{0} अपडेट हो रहा है…",
        RemoteScanningWithCount = "{0} अपडेट हो रहा है… {1} / {2} फ़ाइलें",
        SmartPlaylistPreviewCount = "{0} ट्रैक मेल खाते हैं",
        SmartPlaylistPreviewComputing = "गणना हो रही है…",
        SmartPlaylistPreviewInvalid = "अमान्य मानदंड",
        RestoreQueue = "पिछली कतार",
        RestoreQueueTooltip = "अंतिम चलाई गई कतार बहाल करें",
        NoPreviousQueue = "कोई पिछली कतार उपलब्ध नहीं है।",
        ClearQueue = "कतार खाली करें",
        QueueCleared = "कतार खाली कर दी गई।",
        RecentlyPlayed = "हाल में चलाए गए",
        GreetingMorning = "सुप्रभात",
        GreetingAfternoon = "शुभ दोपहर",
        GreetingEvening = "शुभ संध्या",
        DashboardTagline = "आपका निजी संगीत केंद्र",
        DashboardWelcomeBack = "फिर स्वागत है",
        DashboardHeroHint = "बेहतरीन संगीत के लिए तैयार हैं? कुछ नया खोजें या अपने पसंदीदा पर लौटें।",
        DashboardRandomPlayback = "यादृच्छिक प्लेबैक",
        InfiniteMixStart = "अनवरत मिक्स शुरू करें",
        GenreCloudInfiniteMix = "क्लाउड से अनवरत मिक्स शुरू करें",
        InfiniteMixStop = "अनवरत मिक्स रोकें",
        InfiniteMixActive = "अनवरत मिक्स सक्रिय · ट्रैक स्वतः जुड़ते हैं",
        InfiniteMixCalculating = "आपका अनवरत मिक्स तैयार हो रहा है …",
        InfiniteMixSettingsTitle = "अनवरत मिक्स समायोजित करें",
        InfiniteMixSettingsHint = "चुनें कि Orynivo अगला मिक्स कैसे बनाए, जिसमें ट्रैक लगातार जुड़ते रहें।",
        InfiniteMixMood = "मूड",
        InfiniteMixMoodCalm = "शांत",
        InfiniteMixMoodBalanced = "संतुलित",
        InfiniteMixMoodEnergetic = "ऊर्जावान",
        InfiniteMixDiscovery = "खोज का स्तर",
        InfiniteMixFamiliar = "परिचित",
        InfiniteMixAdventurous = "नए अनुभव",
        InfiniteMixPeriod = "सुनने का इतिहास",
        InfiniteMixSources = "स्रोत",
        InfiniteMixWeightFavorites = "पसंदीदा को अधिक महत्त्व दें",
        InfiniteMixPreferRare = "कम चलाए गए ट्रैक को प्राथमिकता दें",
        InfiniteMixIncludeGenres = "शैलियाँ शामिल करें",
        InfiniteMixExcludeGenres = "शैलियाँ बाहर रखें",
        InfiniteMixGenresWatermark = "शैली दर्ज करें…",
        InfiniteMixAddGenre = "जोड़ें",
        InfiniteMixRemoveGenre = "शैली हटाएँ",
        InfiniteMixPaused = "अनवरत मिक्स विराम पर है",
        InfiniteMixPause = "अनवरत मिक्स को विराम दें",
        InfiniteMixResume = "अनवरत मिक्स जारी रखें",
        InfiniteMixAdjust = "मिक्स समायोजित करें",
        InfiniteMixReplaceNext = "अगला सुझाव बदलें",
        InfiniteMixMoreLikeThis = "ऐसे और",
        InfiniteMixLessLikeThis = "ऐसे कम",
        InfiniteMixExcludeTrack = "आगे इस ट्रैक को बाहर रखें",
        DashboardQuickAccess = "त्वरित पहुँच",
        DashboardTotalMinutes = "कुल मिनट",
        DashboardMinutesShort = "मिनट",
        PeriodPrevious = "पिछली अवधि की तुलना में",
        ShowAll = "सभी दिखाएँ",
        DevicePcmSampleRates = "समर्थित PCM सैंपल दरें",
        DeviceDsdRates = "DSD दरें",
        DevicePcmFormats = "PCM आउटपुट प्रारूप",
        DeviceDsdFormats = "DSD आउटपुट प्रारूप",
        DeviceChannelSummary = "{0} आउटपुट चैनल · {1} इनपुट चैनल",
        DeviceBufferSummary = "बफ़र: न्यूनतम {0}, पसंदीदा {1}, अधिकतम {2}, चरण आकार {3}",
        DriverProvidedNoInformation = "ड्राइवर ने कोई जानकारी नहीं दी।",
        DsdSupportedWithoutFormats = "DSD मोड समर्थित है; कोई विशिष्ट चैनल प्रारूप नहीं बताया गया।",
        Unsupported = "समर्थित नहीं।",
        DeviceProbeInconclusive = "निर्णायक जाँच नहीं हो सकी। कोई अन्य ऐप डिवाइस उपयोग कर रहा हो सकता है।",
        WasapiEndpointSummary = "WASAPI एंडपॉइंट · {0} चैनल\nमिक्स प्रारूप: {1} · {2} बिट",
        WasapiNoExclusiveFormats = "कोई एक्सक्लूसिव PCM प्रारूप नहीं मिला।",
        WasapiDsdNotRelevant = "इस प्लेयर में WASAPI के लिए लागू नहीं।",
        LinuxAlsaEndpointSummary = "सीधा ALSA डिवाइस · {0} चैनल\nPCM: {1} बिट · ट्रैक की सटीक सैंपल दर\nALSA रीसैंपलिंग बंद",
        LinuxOpenAlEndpointSummary = "OpenAL डिवाइस · {0} चैनल\nPCM: {1} बिट · मिक्सर सैंपल दर प्लेबैक के दौरान पता की जाती है",
        LinuxDsdOutputUnavailable = "इस PCM आउटपुट पथ के लिए अभी उपलब्ध नहीं।",
        NativeDsdUsesAsio = "इस प्लेयर में नेटिव DSD प्लेबैक ASIO उपयोग करता है।",
        Dashboard = "डैशबोर्ड",
        DashboardIntroTitle = "आपके सुनने का सारांश",
        DashboardIntroHint = "हाल में जोड़े एल्बम, कैलेंडर में सुनने का समय और अपनी प्रमुख शैलियाँ एक नज़र में देखें।",
        ArtistsIntroTitle = "कलाकार खोजें",
        ArtistsIntroHint = "कलाकार के अनुसार संग्रह देखें, सीधे एल्बम खोलें और पसंदीदा व कलाकार चित्र प्रबंधित करें।",
        AlbumsIntroTitle = "एल्बम देखें",
        AlbumsIntroHint = "तालिका और कवर दृश्य के बीच बदलें, एल्बम ट्रैक खोलें और अनुपलब्ध कवर जोड़ें।",
        TracksIntroTitle = "ट्रैक प्रबंधित करें",
        TracksIntroHint = "शैली, प्रारूप और बिटरेट फ़िल्टर से स्थानीय संगीत संग्रह खोजें, छाँटें और चलाएँ।",
        FoldersIntroTitle = "फ़ोल्डर संरचना",
        FoldersIntroHint = "कॉन्फ़िगर किए संग्रह फ़ोल्डर में संगीत देखें और उनके फ़ोल्डर संदर्भ से ट्रैक चलाएँ।",
        ThemeLight = "हल्का",
        ThemeDark = "गहरा",
        ...
        LanguageSpanish = "स्पेनी",
        LanguageRussian = "रूसी",
        LanguageChineseSimplified = "सरलीकृत चीनी",
        PcmIntegerFormat = "{0}-बिट PCM, लिटल-एंडियन ({1})",
        PcmContainerFormat = "{1}-बिट कंटेनर में {0}-बिट PCM, लिटल-एंडियन ({2})",
        PcmFloatFormat = "{0}-बिट फ़्लोटिंग-पॉइंट PCM, लिटल-एंडियन ({1})",
        NativeDsdLsbFormat = "नेटिव DSD, 1-बिट डेटा, पहला सैंपल सबसे कम महत्त्वपूर्ण बिट में ({0})",
        NativeDsdMsbFormat = "नेटिव DSD, 1-बिट डेटा, पहला सैंपल सबसे अधिक महत्त्वपूर्ण बिट में ({0})",
        NativeDsdWordFormat = "नेटिव DSD, 8-बिट वर्ड, एंडियन क्रम अप्रासंगिक ({0})",
        CountEntrySingular = "{0:N0} प्रविष्टि",
        CountTrackSingular = "{0:N0} ट्रैक",
        Streaming = "स्ट्रीमिंग",
        StreamingServices = "स्ट्रीमिंग सेवाएँ",
        Qobuz = "Qobuz",
        QobuzApplicationId = "Qobuz एप्लिकेशन ID",
        QobuzIntegrationHint = "Qobuz एकीकरण तैयार है। स्वीकृत साझेदार पहुँच और आधिकारिक API दस्तावेज़ उपलब्ध होने पर कैटलॉग और प्लेबैक सक्षम होंगे।",
        QobuzCredentialsHint = "गोपनीय मान और साइन-इन टोकन settings.json में नहीं रखे जाते। Windows इन्हें वर्तमान उपयोगकर्ता के लिए सुरक्षित रखता है।",
        SearchArtistImage = "कलाकार चित्र खोजें",
        UploadArtistImage = "कलाकार चित्र अपलोड करें",
        DeleteArtistImage = "कलाकार चित्र हटाएँ",
        UploadCover = "कवर अपलोड करें",
        ImageFileType = "चित्र फ़ाइलें",
        ArtistImageSearchTitle = "कलाकार चित्र खोजें",
        ArtistImageSearchRunning = "मेल खाते कलाकार चित्र खोजे जा रहे हैं …",
        ArtistImageSearchNoResults = "कोई कलाकार चित्र नहीं मिला।",
        ArtistImageSearchQuery = "खोज शब्द",
        ArtistImageSearchFailed = "कलाकार चित्र खोज विफल।",
        UseSelectedArtistImage = "चुना हुआ चित्र उपयोग करें",
        ArtistImageDownloadFailed = "चुना हुआ कलाकार चित्र सहेजा नहीं जा सका।",
        CoverSearchFailed = "कवर लोड नहीं हो सका। कृपया फिर से प्रयास करें।",
        CoverOriginalLoading = "मूल कवर डाउनलोड हो रहा है …",
        ArtistProfileSearchTitle = "कलाकार की जानकारी फिर लोड करें",
        ArtistProfileSearchHint = "ज़रूरत हो तो वह नाम बदलें जिससे Wikipedia या Last.fm कलाकार प्रोफ़ाइल खोजता है। इससे आपके संग्रह में कलाकार का नाम नहीं बदलता।",
        ArtistProfileSearchQuery = "प्रोफ़ाइल खोज नाम",
        ArtistProfileSearchLoad = "जानकारी लोड करें",
        EditArtistName = "कलाकार का नाम संपादित करें",
        ArtistName = "कलाकार का नाम",
        RenameArtist = "नाम बदलें",
        MergeArtistsTitle = "कलाकार मिलाएँ",
        ArtistNameExistsMessage = "“{0}” नाम का कलाकार पहले से मौजूद है। क्या दोनों कलाकारों को मिलाना है? चुनें कि कौन-सा रिकॉर्ड और प्रोफ़ाइल जानकारी रखी जाए।",
        KeepArtistProfile = "“{0}” को प्राथमिकता दें और मिलाएँ",
        ArtistRenameFailed = "कलाकार का नाम बदला या उसे मिलाया नहीं जा सका।",
        Shuffle = "शफ़ल",
        SearchLyrics = "गीत के बोल खोजें",
        LyricsSearchTitle = "गीत के बोल खोजें",
        LyricsSearchRunning = "मेल खाते गीत के बोल खोजे जा रहे हैं …",
        LyricsSearchNoResults = "मेल खाते गीत के बोल नहीं मिले।",
        LyricsSearchFailed = "गीत के बोल की खोज विफल।",
        UseSelectedLyrics = "चुने हुए गीत के बोल उपयोग करें",
        SelectLyricsResult = "पूर्वावलोकन के लिए बाईं ओर गीत के बोल चुनें।",
        SynchronizedLyrics = "समय-संयोजित",
        InternetRadio = "इंटरनेट रेडियो",
        OwnRadios = "मेरे रेडियो",
        RadioDirectory = "स्टेशन खोजें",
        RadioDirectoryHint = "निःशुल्क Radio Browser निर्देशिका में खोजें और स्टेशनों को अपने रेडियो में स्थायी रूप से जोड़ें।",
        RadioSearch = "स्टेशन खोजें",
        RadioStation = "स्टेशन",
        Country = "देश",
        PlayRadio = "चलाएँ",
        AddToOwnRadios = "मेरे रेडियो में जोड़ें",
        DeleteRadio = "स्टेशन हटाएँ",
        RadioLoading = "रेडियो स्टेशन लोड हो रहे हैं …",
        RadioNoResults = "कोई मेल खाता रेडियो स्टेशन नहीं मिला।",
        RadioEmptyState = "स्टेशन नाम, देश या शैली से खोजें, या मिले स्टेशनों को “मेरे रेडियो” में सहेजें।",
        OwnRadiosEmptyHint = "अभी कोई रेडियो स्टेशन सहेजा नहीं गया। इंटरनेट रेडियो निर्देशिका में खोजें और यहाँ स्टेशन जोड़ें।",
        RadioAdded = "रेडियो स्टेशन “{0}” जोड़ा गया।",
        RadioDeleted = "रेडियो स्टेशन “{0}” हटाया गया।",
        RadioSearchFailed = "रेडियो स्टेशन लोड नहीं किए जा सके।",
        RadioNowPlaying = "अभी प्रसारित",
        RadioMetadataUnavailable = "स्टेशन अभी ट्रैक जानकारी नहीं दे रहा है।",
        RadioGenres = "शैलियाँ",
        ClearFilter = "फ़िल्टर हटाएँ",
        Podcasts = "पॉडकास्ट",
        MyPodcasts = "मेरे पॉडकास्ट",
        PodcastDirectory = "पॉडकास्ट खोजें",
        PodcastDirectoryHint = "Apple Podcasts निर्देशिका में खोजें, पॉडकास्ट स्थायी रूप से पिन करें और RSS फ़ीड से नवीनतम एपिसोड चलाएँ।",
        PodcastSearch = "पॉडकास्ट खोजें",
        Podcast = "पॉडकास्ट",
        PodcastAuthor = "लेखक",
        PlayLatestEpisode = "नवीनतम चलाएँ",
        AddToMyPodcasts = "मेरे पॉडकास्ट में जोड़ें",
        DeletePodcast = "पॉडकास्ट हटाएँ",
        PodcastLoading = "पॉडकास्ट लोड हो रहे हैं …",
        PodcastNoResults = "कोई मेल खाता पॉडकास्ट नहीं मिला।",
        PodcastEmptyState = "पॉडकास्ट खोजें, श्रेणी या भाषा से फ़िल्टर करें और पसंदीदा को “मेरे पॉडकास्ट” में पिन करें।",
        MyPodcastsEmptyHint = "अभी कोई पॉडकास्ट पिन नहीं किया गया। पॉडकास्ट निर्देशिका में खोजें और यहाँ जोड़ें।",
        PodcastAdded = "पॉडकास्ट “{0}” जोड़ा गया।",
        PodcastDeleted = "पॉडकास्ट “{0}” हटाया गया।",
        PodcastSearchFailed = "पॉडकास्ट लोड नहीं किए जा सके।",
        PodcastFeedFailed = "पॉडकास्ट फ़ीड में चलाने योग्य एपिसोड नहीं मिला।",
        ShowEpisodes = "एपिसोड दिखाएँ",
        Published = "प्रकाशित",
        Progress = "प्रगति",
        PodcastStatus = "स्थिति",
        PodcastUnplayed = "नया",
        PodcastInProgress = "शुरू किया",
        PodcastPlayed = "सुना गया",
        PodcastEpisodesLoading = "पॉडकास्ट एपिसोड लोड हो रहे हैं …",
        PodcastNoEpisodes = "इस फ़ीड में चलाने योग्य एपिसोड नहीं मिले।",
        PodcastCategories = "श्रेणियाँ",
        PodcastLanguages = "भाषाएँ",
        PodcastLanguage = "भाषा",
        PodcastLanguagesLoading = "फ़ीड से पॉडकास्ट की भाषाएँ पहचानी जा रही हैं …",
        PodcastOverview = "पॉडकास्ट सारांश",
        PodcastEpisodeTotal = "कुल {0:N0} एपिसोड",
        PodcastEpisodeUnheard = "{0:N0} अभी नहीं सुने गए",
        PodcastEpisodeStarted = "{0:N0} शुरू किए गए",
        PodcastLatestEpisode = "नवीनतम एपिसोड: {0}",
        DailyHistoryTitle = "सुनने का इतिहास – {0}",
        PlayedAt = "चलाने का समय",
        ListenedDuration = "सुना गया",
        MediaType = "प्रकार",
        Close = "बंद करें",
        DailyHistoryNoEntries = "इस दिन के लिए कोई प्लेबैक प्रविष्टि नहीं है।",
        SidebarSections = "साइडबार अनुभाग",
        SidebarSectionsHint = "चुनें कि मुख्य नेविगेशन में कौन-से संकुचित किए जा सकने वाले अनुभाग दिखें।",
        PodcastInfo = "पॉडकास्ट जानकारी",
        ShowPodcastInfo = "पॉडकास्ट जानकारी दिखाएँ",
        ClosePodcastInfo = "पॉडकास्ट जानकारी बंद करें",
        PodcastPublishedOn = "{0} को प्रकाशित",
        PodcastEpisodeDuration = "अवधि {0}",
        PodcastDescriptionUnavailable = "इस एपिसोड का सारांश उपलब्ध नहीं है।",
        PlexServers = "PLEX सर्वर",
        PlexServersSettings = "Plex सर्वर",
        PlexServersHint = "एक या अधिक Plex Media Server कॉन्फ़िगर करें। एक्सेस टोकन वर्तमान Windows उपयोगकर्ता खाते के लिए सुरक्षित हैं।",
        AddPlexServer = "Plex सर्वर जोड़ें",
        PlexServerDialogTitle = "Plex सर्वर",
        PlexServerName = "प्रदर्शन नाम",
        PlexServerUrl = "सर्वर URL",
        PlexToken = "X-Plex-Token (वैकल्पिक)",
        PlexTestConnection = "कनेक्शन जाँचें",
        PlexTestingConnection = "कनेक्शन जाँचा जा रहा है…",
        PlexConnectionSuccessful = "कनेक्शन सफल। {0:N0} ऑडियो संग्रह मिले।",
        PlexConnectionFailed = "कनेक्शन विफल: {0}",
        PlexServerFieldsRequired = "नाम और सर्वर URL आवश्यक हैं।",
        PlexServerUrlInvalid = "मान्य HTTP या HTTPS URL दर्ज करें।",
        PlexEditServer = "संपादित करें",
        PlexRemoveServer = "हटाएँ",
        PlexNoAudioLibraries = "कोई ऑडियो संग्रह नहीं मिला।",
        PlexLoading = "Plex सामग्री लोड हो रही है…",
        OrynivoServers = "ORYNIVO सर्वर",
        SourceColumn = "स्रोत",
        LocalSource = "स्थानीय",
        LocalSourceShort = "L",
        OrynivoServersSettings = "Orynivo सर्वर",
        OrynivoServersHint = "प्लेयर को स्थानीय नेटवर्क पर एक या अधिक Orynivo सर्वर से जोड़ें। API कुंजी वर्तमान उपयोगकर्ता के क्रेडेंशियल भंडार में एन्क्रिप्ट करके रखी जाती है।",
        AddOrynivoServer = "सर्वर जोड़ें",
        OrynivoServerDialogTitle = "Orynivo सर्वर",
        OrynivoServerName = "प्रदर्शन नाम",
        OrynivoServerUrl = "सर्वर URL (जैसे http://192.168.1.10:5280)",
        OrynivoServerApiKey = "API कुंजी",
        OrynivoTestConnection = "कनेक्शन जाँचें",
        OrynivoTestingConnection = "कनेक्शन जाँचा जा रहा है…",
        OrynivoConnectionSuccessful = "कनेक्ट हुआ। सर्वर: {0} v{1}",
        OrynivoConnectionFailed = "कनेक्शन विफल। URL और API कुंजी जाँचें।",
        OrynivoServerFieldsRequired = "नाम, URL और API कुंजी आवश्यक हैं।",
        OrynivoEditServer = "संपादित करें",
        OrynivoRemoveServer = "हटाएँ",
        OrynivoLoading = "सर्वर सामग्री लोड हो रही है…",
        OrynivoServerDirectories = "सर्वर के संगीत फ़ोल्डर",
        OrynivoLoadServerDirectories = "सर्वर से लोड करें",
        OrynivoAddServerDirectory = "फ़ोल्डर जोड़ें",
        OrynivoLoadingServerDirectories = "सर्वर फ़ोल्डर लोड हो रहे हैं…",
        OrynivoServerDirectoriesLoaded = "सर्वर फ़ोल्डर लोड हुए।",
        OrynivoServerDirectoriesLoadFailed = "सर्वर फ़ोल्डर लोड नहीं किए जा सके।",
        OrynivoSavingServerDirectories = "सर्वर फ़ोल्डर सहेजे जा रहे हैं…",
        OrynivoServerDirectoriesSaveFailed = "सर्वर फ़ोल्डर सहेजे नहीं जा सके।",
        OrynivoCalculateReplayGainDuringScan = "सर्वर स्कैन में अनुपलब्ध ReplayGain की गणना करें (धीमा)",
        OrynivoSavingReplayGainSettings = "सर्वर पर ReplayGain स्कैन सेटिंग सहेजी जा रही है…",
        OrynivoReplayGainSettingsSaveFailed = "सर्वर पर ReplayGain स्कैन सेटिंग सहेजी नहीं जा सकी।",
        OrynivoReplayGainSettingsUnsupported = "फ़ोल्डर लोड हुए। यह सर्वर अभी ReplayGain स्कैन सेटिंग समर्थित नहीं करता।",
        OrynivoNoServerDirectories = "कोई सर्वर फ़ोल्डर कॉन्फ़िगर नहीं है।",
        OrynivoServerDirectoryBrowserTitle = "सर्वर फ़ोल्डर चुनें",
        OrynivoServerDirectoryRoots = "मूल फ़ोल्डर",
        OrynivoServerDirectoryUp = "ऊपर",
        OrynivoSelectServerDirectory = "चुनें",
        OrynivoServerDirectoryLoading = "फ़ोल्डर लोड हो रहा है…",
        OrynivoServerDirectoryLoadFailed = "फ़ोल्डर लोड नहीं किया जा सका।",
        OrynivoServerDirectoryEmpty = "कोई उपफ़ोल्डर उपलब्ध नहीं है।",
        OrynivoServerScan = "सर्वर स्कैन",
        OrynivoStartServerScan = "संग्रह स्कैन करें",
        OrynivoCalculateServerReplayGain = "ReplayGain की गणना करें",
        OrynivoServerScanStarting = "सर्वर स्कैन शुरू हो रहा है…",
        OrynivoServerScanStartFailed = "सर्वर स्कैन शुरू नहीं किया जा सका।",
        OrynivoServerScanIdle = "कोई सर्वर स्कैन नहीं चल रहा।",
        OrynivoServerScanDiscovering = "फ़ाइलें खोजी जा रही हैं: {0}",
        OrynivoServerScanProgress = "{0}/{1} · {2}",
        OrynivoServerScanCompleted = "स्कैन पूरा: {0} फ़ाइलें, {1} जोड़ी गईं, {2} अपडेट, {3} हटाई गईं, {4} विफल।",
        OrynivoServerScanFailed = "सर्वर स्कैन विफल: {0}",
        OrynivoServerBackup = "सर्वर संग्रह का बैकअप लें",
        OrynivoDownloadBackup = "बैकअप डाउनलोड करें",
        OrynivoRestoreBackup = "बैकअप बहाल करें",
        OrynivoBackupDownloading = "सर्वर बैकअप डाउनलोड हो रहा है…",
        OrynivoBackupDownloaded = "सर्वर बैकअप सहेजा गया: {0}",
        OrynivoBackupRestoring = "सर्वर बैकअप की जाँच और बहाली हो रही है…",
        OrynivoBackupRestored = "सर्वर बैकअप सफलतापूर्वक बहाल हुआ।",
        OrynivoBackupFailed = "सर्वर बैकअप विफल: {0}",
        OrynivoRestoreBackupConfirm = "आयात सर्वर डेटाबेस, प्लेलिस्ट, इतिहास, कवर, कलाकार चित्र और फ़ोल्डर सूची बदल देगा। ऑडियो फ़ाइलें नहीं बदलेंगी। जारी रखें?",
        LoadMore = "और लोड करें",
        FfmpegDownloading = "FFmpeg डाउनलोड हो रहा है …",
        FfmpegDownloadFailed = "FFmpeg डाउनलोड नहीं किया जा सका। कृपया स्वयं इंस्टॉल करें: ffmpeg.org",
        SmartPlaylistDialogTitle = "स्मार्ट प्लेलिस्ट संपादित करें",
        SmartPlaylistName = "नाम",
        SmartPlaylistBasicFilters = "मूल फ़िल्टर",
        SmartPlaylistGenres = "शैलियाँ (अल्पविराम से अलग)",
        SmartPlaylistFormats = "प्रारूप (जैसे FLAC, MP3; अल्पविराम से अलग)",
        SmartPlaylistBitrates = "बिटरेट kbps में (अल्पविराम से अलग)",
        SmartPlaylistSources = "स्रोत (local या server:<id>; अल्पविराम से अलग)",
        SmartPlaylistMetadata = "मेटाडेटा",
        SmartPlaylistMinimumYear = "वर्ष से",
        SmartPlaylistMaximumYear = "वर्ष तक",
        SmartPlaylistSearchText = "खोज पाठ में शामिल",
        SmartPlaylistArtistContains = "कलाकार में शामिल",
        SmartPlaylistAlbumContains = "एल्बम में शामिल",
        SmartPlaylistMinimumDuration = "न्यूनतम अवधि मिनट में",
        SmartPlaylistMaximumDuration = "अधिकतम अवधि मिनट में",
        SmartPlaylistHistory = "संग्रह और प्लेबैक इतिहास",
        SmartPlaylistAddedWithinDays = "पिछले X दिनों में जोड़े गए",
        SmartPlaylistPlayedWithinDays = "पिछले X दिनों में चलाए गए",
        SmartPlaylistNeverPlayed = "कभी नहीं चलाया",
        SmartPlaylistMinimumPlayCount = "न्यूनतम प्लेबैक संख्या",
        SmartPlaylistMaximumPlayCount = "अधिकतम प्लेबैक संख्या",
        SmartPlaylistResult = "परिणाम",
        SmartPlaylistSortOrder = "क्रम",
        SmartPlaylistSortTitle = "शीर्षक A–Z",
        SmartPlaylistSortRandom = "यादृच्छिक",
        SmartPlaylistSortLastPlayed = "हाल में चलाए गए पहले",
        SmartPlaylistSortLeastRecentlyPlayed = "सबसे लंबे समय से न चलाए गए पहले",
        SmartPlaylistResultLimit = "अधिकतम ट्रैक संख्या (खाली = असीमित)",
        CreateSmartPlaylist = "स्मार्ट प्लेलिस्ट बनाएँ",
        InvalidSmartPlaylistCriteria = "मान्य संख्याएँ और संगत न्यूनतम/अधिकतम मान दर्ज करें। “कभी नहीं चलाया” को हाल के प्लेबैक या शून्य से अधिक न्यूनतम प्लेबैक संख्या के साथ नहीं जोड़ सकते।",
        EditSmartPlaylist = "स्मार्ट प्लेलिस्ट संपादित करें",
        LibraryEmptyHint = "अभी कोई मीडिया स्रोत कॉन्फ़िगर नहीं है। सेटिंग्स > संग्रह खोलें, स्थानीय संगीत फ़ोल्डर जोड़ें या Orynivo सर्वर से जुड़ें।",
        SmartPlaylistUpdated = "स्मार्ट प्लेलिस्ट '{0}' अपडेट हुई।",
        ImportM3u8Playlist = "M3U8 प्लेलिस्ट आयात करें",
        ExportM3u8Playlist = "M3U8 के रूप में निर्यात करें",
        SaveAlbumAsPlaylist = "प्लेलिस्ट के रूप में सहेजें",
        AlbumPath = "एल्बम पथ",
        UpNext = "आगे चलने वाले",
        GenreExplorer = "शैली क्लाउड",
        GenreCloudHint = "स्थानीय संग्रह और हर जुड़े Orynivo सर्वर की शैलियाँ खोजें। विस्तार से देखने के लिए कोई शैली चुनें।",
        AllGenres = "सभी शैलियाँ",
        GenreRecommendations = "सुझाए गए ट्रैक",
        GenreCloudEmpty = "अभी कोई शैली नहीं मिली। जाँचें कि आपके ट्रैक में शैली टैग हैं।",
        MoreGenres = "और शैलियाँ",
        PlayNext = "अगला चलाएँ",
        AppendToQueue = "कतार के अंत में जोड़ें",
        RemoveFromQueue = "कतार से हटाएँ",
        MoveUp = "ऊपर ले जाएँ",
        MoveDown = "नीचे ले जाएँ",
        SaveQueueAsPlaylist = "कतार को प्लेलिस्ट के रूप में सहेजें",
        TracksQueuedNext = "{0:N0} ट्रैक आगे चलेंगे।",
        TracksAppendedToQueue = "{0:N0} ट्रैक कतार के अंत में जोड़े गए।",
        M3u8ImportCompleted = "प्लेलिस्ट '{0}' आयात हुई: {1} प्रविष्टियाँ · {2} स्थानीय फ़ाइलें अनुपलब्ध · {3} HTTP प्रविष्टियाँ · {4} छोड़ी गईं।",
        M3u8ImportNoEntries = "M3U8 फ़ाइल में आयात योग्य प्रविष्टियाँ नहीं हैं।",
        M3u8ImportFailed = "M3U8 आयात विफल: {0}",
        M3u8ExportCompleted = "प्लेलिस्ट '{0}' M3U8 के रूप में निर्यात हुई: {1} प्रविष्टियाँ · {2} छोड़ी गईं।",
        M3u8ExportFailed = "M3U8 निर्यात विफल: {0}",
        McpServer = "MCP सर्वर",
        McpServerHint = "स्थानीय HTTP/SSE सर्वर खोलता है जिससे AI सहायक (जैसे Claude Desktop) प्लेयर नियंत्रित और संग्रह खोज सकते हैं।",
        McpServerEnabled = "MCP सर्वर सक्षम करें",
        McpServerPort = "पोर्ट",
        McpNetworkAccess = "स्थानीय नेटवर्क से पहुँच की अनुमति दें",
        McpNetworkAccessHint = "MCP को सभी नेटवर्क इंटरफ़ेस से जोड़ता है। नेटवर्क अनुरोधों के लिए बेयरर टोकन ज़रूरी है। HTTPS या VPN के बिना टोकन नेटवर्क पर देखा जा सकता है।",
        McpAccessToken = "एक्सेस टोकन",
        McpAccessTokenWatermark = "सक्षम करने पर स्वतः बनेगा",
        McpGenerateToken = "नया बनाएँ",
        MobileRemote = "मोबाइल वेब रिमोट",
        MobileRemoteHint = "स्थानीय नेटवर्क पर रिमोट नियंत्रण देता है। इसका अलग एक्सेस टोकन उपयोग करें और घरेलू नेटवर्क से बाहर की पहुँच HTTPS या VPN से सुरक्षित करें।",
        MobileRemoteEnabled = "नेटवर्क पर मोबाइल रिमोट सक्षम करें",
        MobileRemotePort = "पोर्ट",
        MobileRemoteToken = "रिमोट एक्सेस टोकन",
        MobileRemoteNetworkAddress = "घरेलू नेटवर्क का IP पता",
        MobileRemoteQrHint = "पहले सेटिंग्स सहेजें। सीधे साइन-इन के लिए उसी Wi-Fi पर QR कोड स्कैन करें। इसमें एक्सेस टोकन है: इसे साझा न करें! URL स्वयं खोलने पर टोकन माँगा जाएगा। कई पते दिखें तो वह चुनें जो आपके फ़ोन से पहुँच योग्य हो।",
        Integration = "एकीकरण",
        McpToolsHeader = "टूल",
        McpToolsHint = "अलग-अलग टूल सक्षम या अक्षम करें।",
        WebBrowsing = "वेब ब्राउज़िंग",
        WebBrowsingHint = "AI को नियंत्रित वेब टूल देता है: SearXNG खोज और सुरक्षित पृष्ठ प्राप्ति। निजी और स्थानीय पते अवरुद्ध हैं (SSRF सुरक्षा)।",
        WebBrowsingEnabled = "वेब टूल सक्षम करें",
        SearxngUrl = "SearXNG URL",
        WebBlockPrivate = "निजी/स्थानीय पते अवरुद्ध करें (SSRF सुरक्षा)",
        WebMaxResults = "अधिकतम खोज परिणाम",
        WebTimeoutSeconds = "समय-सीमा (सेकंड)",
        WebMaxResponseKb = "अधिकतम उत्तर आकार (KB)",
        AiChat = "AI चैट",
        AiChatSettings = "AI चैट",
        AiChatHint = "OpenAI-संगत API (जैसे LM Studio, Ollama, OpenAI) से स्थानीय या क्लाउड AI मॉडल से जुड़ता है। मॉडल संग्रह खोजने, प्लेलिस्ट प्रबंधित करने और प्लेबैक नियंत्रित करने के लिए Orynivo के सभी 32 टूल उपयोग कर सकता है।",
        AiChatEnabled = "AI चैट सक्षम करें",
        AiChatEndpointUrl = "एंडपॉइंट URL",
        AiChatApiKey = "API कुंजी (वैकल्पिक)",
        AiChatLocalNote = "LM Studio और Ollama को API कुंजी की ज़रूरत नहीं होती।",
        AiChatModel = "मॉडल",
        AiChatLoadModels = "मॉडल लोड करें",
        AiChatAvailableModels = "उपलब्ध मॉडल चुनें",
        AiChatTestConnection = "कनेक्शन जाँचें",
        AiChatConnectionTesting = "कनेक्शन जाँचा जा रहा है …",
        AiChatModelsLoaded = "{0} मॉडल लोड हुए।",
        AiChatConnectionSucceeded = "कनेक्शन सफल; {0} मॉडल उपलब्ध हैं।",
        AiChatNoModels = "कनेक्शन सफल, लेकिन एंडपॉइंट ने कोई मॉडल नहीं बताया।",
        AiChatConnectionFailed = "कनेक्शन विफल। एंडपॉइंट URL और API कुंजी जाँचें।",
        AiChatMaxTokens = "अधिकतम टोकन",
        AiChatInputPlaceholder = "प्रश्न पूछें …",
        AiChatSend = "भेजें",
        AiChatClear = "साफ़ करें",
        AiChatCopy = "कॉपी करें",
        AiChatNotEnabled = "AI चैट सक्षम नहीं है। इसे सेटिंग्स › AI चैट में सक्षम करें।",
        ...
        BulkGenrePartiallyFailed = "{0} ट्रैक की शैली अपडेट की; {1} विफल।",
        ...
        ScheduledBackupInterval = "अंतराल (दिनों में)",
        ScheduledBackupRetention = "रखे जाने वाले बैकअप",
        ScheduledBackupFolder = "बैकअप फ़ोल्डर",
        ChooseFolder = "फ़ोल्डर चुनें…",
        RunBackupNow = "अभी बैकअप लें",
        ScheduledBackupLastRun = "अंतिम बैकअप: {0}",
        ScheduledBackupNever = "कभी नहीं",
        ScheduledBackupRunning = "बैकअप बनाया जा रहा है…",
        ScheduledBackupFinished = "बैकअप पूरा हुआ।",
        ScheduledBackupFailed = "बैकअप विफल रहा।",
        ScheduledBackupDone = "बैकअप बनाया गया: {0}",
        VisualizerPresetFolder = "प्रीसेट फ़ोल्डर",
        VisualizerPresetFolderHint = "अपने प्रीसेट .oryvis या .milk फ़ाइलों के रूप में रखें। समर्थित अभिव्यक्ति उपसमुच्चय लागू होता है और अजान कुंजियाँ अनदेखी की जाती हैं; न पढ़ी जा सकने वाली फ़ाइलें छोड़ दी जाती हैं।",
        VisualizerPresetRejected = "प्रीसेट छोड़े गए",
        Visualizer = "विजुअलाइजर",
        VisualizerHint = "स्पेस या क्लिक: अगला प्रीसेट · तीर कुंजी: पिछला/अगला · R: रीसेट · Esc: बंद करें",
        VisualizerPresetLabel = "प्रीसेट: {0}",
        VisualizerOverlayAlways = "टेक्स्ट और नियंत्रण हमेशा दिखाएँ",
        VisualizerOverlayAlwaysHint = "बंद होने पर शीर्षक, संकेत और प्लेबैक बटन केवल विज़ुअलाइज़र पर माउस हिलाने पर दिखते हैं और फिर छिप जाते हैं।",
        VisualizerResolution = "रिज़ॉल्यूशन",
        VisualizerResolutionHint = "कम रिज़ॉल्यूशन CPU पर कम भार डालते हैं; तस्वीर को विंडो के आकार तक बढ़ाया जाता है।",
        VisualizerFrameRate = "फ़्रेम दर",
        VisualizerFrameRateHint = "अधिक फ़्रेम दर चिकनी दिखती है, पर CPU अधिक लेती है।",
        VisualizerAutoAdvance = "प्रीसेट स्वतः बदलें",
        VisualizerAutoAdvanceHint = "निर्धारित समय के बाद अगला प्रीसेट स्वतः दिखाता है।",
        VisualizerAutoAdvanceSeconds = "प्रति प्रीसेट प्रदर्शन समय (सेकंड)",
        VisualizerPresetBlendSeconds = "प्रीसेट बदलाव क्रॉस-फ़ेड अवधि (सेकंड)",
        VisualizerPresetBlendSecondsHint = "0 पर सीधा बदलाव; अधिक मान पुराने प्रीसेट को नए में धीरे से मिलाता है।",
        VisualizerSelectPresets = "प्रीसेट चुनें…",
        VisualizerSelectPresetsHint = "चुनें कि विज़ुअलाइज़र कौन-से प्रीसेट चलाए; निष्क्रिय प्रीसेट छोड़ दिए जाते हैं।",
        VisualizerPresetDownloadHint = "Orynivo कोई तृतीय-पक्ष प्रीसेट शामिल नहीं करता। MilkDrop 2 प्रीसेट संग्रह डाउनलोड करके प्रीसेट फ़ोल्डर में रखे जा सकते हैं।",
        VisualizerDownloadPresets = "प्रीसेट डाउनलोड करें…",
        VisualizerPresetSelectionTitle = "विज़ुअलाइज़र प्रीसेट",
        VisualizerPresetSelectionHint = "स्विच करते समय और स्वतः बदलाव के दौरान निष्क्रिय प्रीसेट छोड़ दिए जाते हैं।",
        VisualizerPresetSelectionAll = "सभी",
        VisualizerPresetSelectionNone = "कोई नहीं",
        VisualizerPresetSelectionLoading = "प्रीसेट लोड हो रहे हैं…",
        VisualizerPresetSelectionEmpty = "इस फ़ोल्डर में कोई प्रीसेट नहीं मिला।",
        VisualizerPresetSelectionActiveCount = "{1} में से {0} सक्रिय",
        MaxOutputSampleRate = "अधिकतम आउटपुट सैम्पल रेट",
        MaxOutputSampleRateHint = "PCM आउटपुट सैम्पल रेट को सीमित करता है। “स्वचालित” डिवाइस द्वारा दी जाने वाली सबसे ऊँची रेट लेता है; जब ड्राइवर ऐसी रेट बताता है जो वह साफ़ नहीं बजाता, तो सीमित करना बेहतर है।",
        MaxOutputSampleRateAutomatic = "स्वचालित",
        ResumeOnThisDevice = "जारी रखें",
        ResumeOnThisDeviceTooltip = "इस डिवाइस पर {0} से जारी रखें",
        ResumeOnThisDeviceHint = "{0} से जारी रखा गया",
        TransportPrevious = "पिछला ट्रैक",
        TransportPlayPause = "चलाएँ या रोकें",
        TransportNext = "अगला ट्रैक",
        TransportVolume = "वॉल्यूम",
        ReduceMotion = "ऐनिमेशन",
        ReduceMotionHint = "इंटरफ़ेस में गति कम करता है: जॉन्र क्लाउड, डैशबोर्ड स्टेज और कराओके बिना ट्रांजिशन बदलते हैं।",
        ReduceMotionEnabled = "गति कम करें",
        BackupTarget = "क्लाउड बैकअप लक्ष्य",
        BackupTargetHint = "तैयार बैकअप को WebDAV संग्रहण पर भी सहेजता है। पासवर्ड एन्क्रिप्ट करके रखा जाता है और कभी सेटिंग्स फ़ाइल में नहीं लिखा जातа।",
        BackupTargetEnabled = "बैकअप को WebDAV लक्ष्य पर अपलोड करें",
        BackupTargetUrl = "WebDAV पता",
        BackupTargetDirectory = "उप-फ़ोल्डर (वैकल्पिक)",
        BackupTargetUserName = "उपयोगकर्ता नाम (वैकल्पिक)",
        BackupTargetPassword = "पासवर्ड (वैकल्पिक)",
        BackupUploadDone = "बैकअप अपलोड हो गया: {0}",
        BackupUploadFailed = "बैकअप अपलोड विफल रहा।",
        Karaoke = "कराओके",
        ...
        YearInReviewActiveDays = "सक्रिय दिन",
        YearInReviewMonthly = "माह के अनुसार सुनना",
        YearInReviewTopGenres = "शीर्ष शैलियाँ",
        YearInReviewTopAlbums = "शीर्ष एल्बम",
        YearInReviewTopArtists = "शीर्ष कलाकार",
        YearInReviewEmpty = "इस वर्ष के लिए कोई सुनने का इतिहास दर्ज नहीं है।",
        SaveAsImage = "छवि के रूप में सहेजें…",
        YearInReviewImageSaved = "छवि सहेजी गई: {0}",
        YearInReviewImageFailed = "छवि सहेजी नहीं जा सकी।",
        ...
        DuplicateResolutionExact = "बाइट-समान",
        DuplicateResolutionLikely = "संभावित डुप्लिकेट",
        DuplicateResolutionSelected = "हटाने के लिए {0} चयनित",
        DuplicateResolutionRemove = "लाइब्रेरी से हटाएँ",
        DuplicateResolutionDeleteFiles = "फ़ाइलों को डिस्क से भी हटाएँ",
        DuplicateResolutionConfirmRemove = "लाइब्रेरी से {0} फ़ाइलें हटाएँ?",
        DuplicateResolutionConfirmDeleteFiles = "लाइब्रेरी से {0} फ़ाइलें हटाएँ और डिस्क से भी मिटाएँ?",
        DuplicateResolutionNoneFound = "कोई डुप्लिकेट फ़ाइल नहीं मिली।",
        DuplicateResolutionRemoved = "लाइब्रेरी से {0} फ़ाइलें हटाई गईं।",
