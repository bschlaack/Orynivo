...
public static class ThemeManager
{
    ...
    public static void Apply(AppTheme theme)
    {
        ...
        resources["AppAccentBrush"]              = Brush(dark ? "#20D9E8" : "#2563EB");
        resources["AppFavoriteBrush"]            = Brush(dark ? "#FF5D7A" : "#D92D5C");
        resources["AppAccentTextBrush"]          = Brush(dark ? "#102033" : "#FFFFFF");
        resources["AppAccentSoftBrush"]          = Brush(dark ? "#0B3442" : "#DDEBFF");
        resources["AppSidebarBrush"]             = Brush(dark ? "#08111E" : "#F5F7FA");
        resources["AppHeaderBrush"]              = Brush(dark ? "#0B1523" : "#FFFFFF");
        resources["AppHeaderBorderBrush"]        = Brush(dark ? "#1B2D40" : "#E3E8EF");
        resources["AppContentBrush"]             = Brush(dark ? "#0C1725" : "#F7F9FC");
        resources["AppSurfaceBrush"]             = Brush(dark ? "#111E2D" : "#FFFFFF");
        resources["AppSurfaceHoverBrush"]        = Brush(dark ? "#17283A" : "#EEF4FF");
        resources["AppSurfaceSelectedBrush"]     = Brush(dark ? "#1C3446" : "#E4EDFF");
        resources["AppNowPlayingRowBrush"]       = Brush(dark ? "#173B38" : "#DDF7F0");
        resources["AppNavHoverBrush"]            = Brush(dark ? "#111F2E" : "#EAF0F7");
        resources["AppNavSelectedBrush"]         = Brush(dark ? "#123345" : "#DDEBFF");
        ...
        resources["AppGridLineBrush"]            = Brush(dark ? "#203247" : "#E3E8EF");
        resources["AppColumnHeaderBrush"]        = Brush(dark ? "#101F2F" : "#F1F5F9");
        resources["AppTransportBrush"]           = Brush(dark ? "#08131F" : "#FFFFFF");
        resources["AppTransportBorderBrush"]     = Brush(dark ? "#1B3043" : "#E3E8EF");
        ...
        resources["AppTransportPlayBrush"]       = Brush(dark ? "#20D9E8" : "#2563EB");
        resources["AppTransportPlayHoverBrush"]  = Brush(dark ? "#53E6F0" : "#1D4ED8");
        ...
        resources["TextControlBorderBrushFocused"] = Brush(dark ? "#20D9E8" : "#2563EB");
