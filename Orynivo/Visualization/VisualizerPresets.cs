...
internal static class VisualizerPresets
{
    ...
    [
        VisualizerPreset.Parse("""
            ...
            per_frame_3=wave_g = 0.5 + 0.5 * sin(time + 2.1);
            per_frame_4=wave_b = 0.5 + 0.5 * sin(time + 4.2);
            ...
            shape_0_a=0.22
            shape_0_border_a=0
            shape_0_per_frame_1=x = 0.5 + 0.35 * sin(time * 0.7);
            shape_0_per_frame_2=y = 0.5 + 0.35 * cos(time * 0.9);
            shape_0_per_frame_3=rad = 0.22 + bass * 0.3;
            """),
        VisualizerPreset.Parse("""
            name=Nebula
            decay=0.97
            ...
            wave_alpha=0.9
            wave_scale=0.4
            per_frame_1=q1 = time * 0.2;
            per_frame_2=wave_r = 0.4 + 0.6 * sin(q1);
            per_frame_3=wave_g = 0.4 + 0.6 * sin(q1 + 2.1);
            per_frame_4=wave_b = 0.7;
            per_pixel_1=spin = ang + rad * (1.0 + bass * 2.0) + q1;
            per_pixel_2=x = x + cos(spin) * 0.02;
            per_pixel_3=y = y + sin(spin) * 0.02;
            shape_0_sides=40
            shape_0_rad=0.5
            shape_0_r=0.5
            shape_0_g=0.6
            ...
            shape_0_a=0.15
            shape_0_border_a=0
            shape_0_per_frame_1=x = 0.5 + 0.25 * sin(q1 * 1.3);
            shape_0_per_frame_2=y = 0.5 + 0.25 * cos(q1 * 1.1);
            """),
        VisualizerPreset.Parse("""
            name=Tunnel
            decay=0.95
            ...
            per_frame_2=rot = rot + 0.0025 + mid * 0.012;
            per_frame_3=wave_r = 0.9;
            per_frame_4=wave_g = 0.7;
            per_frame_5=wave_b = 0.2;
            per_pixel_1=s = 1 + rad * 0.09 * q1;
            per_pixel_2=x = x * s;
            per_pixel_3=y = y * s;
            """),
        VisualizerPreset.Parse("""
