...
public sealed class PresetVariableLayout
{
    ...
    [
        ...
        "fWarpAnimSpeed", "fWarpScale", "wrap",
        "bass", "mid", "treb", "vol", "bass_att", "mid_att", "treb_att", "vol_att",
        "aspectx", "aspecty", "pixelsx", "pixelsy",
        "decay", "fDecay", "gamma", "shader", "fWarpAmount", "fWaveAlpha", "fWaveScale",
        ...
        "wave_mystery", "wave_smoothing", "wave_usedots", "wave_thick", "wave_additive", "wave_brighten",
        "mod_wave_alpha_by_volume", "mod_wave_alpha_start", "mod_wave_alpha_end",
        "red_blue_stereo", "brighten", "darken", "solarize", "invert",
        "ob_size", "ob_r", "ob_g", "ob_b", "ob_a", "ib_size", "ib_r", "ib_g", "ib_b", "ib_a",
        "mv_x", "mv_y", "mv_dx", "mv_dy", "mv_l", "mv_a", "mv_r", "mv_g", "mv_b", "mv_enabled",
