...
public static class LocalizationManager
{
    ...
    private static readonly LocalizedStrings German = new(
        ...
        "Player ist abgestürzt",
        "Ein unerwarteter Fehler ist aufgetreten. Ein Fehlerbericht wurde hier gespeichert:\n\n{0}\n\nDer Player wird beendet.",
        "Ein unerwarteter Fehler ist aufgetreten. Der Fehlerbericht konnte nicht gespeichert werden. Der Player wird beendet.")
    {
        ...
        WasapiDsdNotRelevant = "Für WASAPI in diesem Player nicht relevant.",
        NativeDsdUsesAsio = "Native DSD-Wiedergabe läuft in diesem Player über ASIO.",
    ...
    private static readonly LocalizedStrings English = new(
        ...
        "Player crashed",
        "An unexpected error occurred. A crash report was saved here:\n\n{0}\n\nPlayer will now close.",
        "An unexpected error occurred. The crash report could not be saved. Player will now close.")
    {
    ...
    private static readonly LocalizedStrings French = new(
        ...
        "Player a cessé de fonctionner",
        "Une erreur inattendue s’est produite. Un rapport a été enregistré ici :\n\n{0}\n\nPlayer va maintenant se fermer.",
        "Une erreur inattendue s’est produite. Le rapport n’a pas pu être enregistré. Player va maintenant se fermer.")
    {
    ...
    private static readonly LocalizedStrings Spanish = new(
        ...
        "Player se ha bloqueado",
        "Se produjo un error inesperado. Se guardó un informe aquí:\n\n{0}\n\nPlayer se cerrará ahora.",
        "Se produjo un error inesperado. No se pudo guardar el informe. Player se cerrará ahora.")
    {
